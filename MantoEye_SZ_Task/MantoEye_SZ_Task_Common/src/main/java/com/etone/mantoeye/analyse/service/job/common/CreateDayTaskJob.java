 ...
 * 
 * @author Wu Zhenzhen
 * @version May 2, 2012 11:52:29 AM
 */
public class CreateDayTaskJob implements Job {

	/**
	 * 日誌
	 */
	private static final Logger logger = LoggerFactory
			.getLogger(CreateDayTaskJob.class);
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		logger.info("[Quartz Job]---- Exec create Day task job.");
		...
		while (flag) {
			if (i++ > 50) {
				logger.warn("Create day task list error,Ingore exec create day task list operation.");
				manager = null;
				break;
			}

			try {
				manager.createDayTaskList();
				flag = false;
				manager = null;
				...
				if (CommonErrorUtil.isTableLockError(e))
					...
					logger.error(
							"第[{}]次createTaskList批量生成天的新任務列表时,报错:\n MASSAGE : {} \n CAUSE :{} \n CLASS : {}\n",
