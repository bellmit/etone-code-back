...
import com.symbol.app.mantoeye.dao.businessAnalyse.ContextDistributeTrendDao;
...
public class ContextDistributeTrendManager {
	@Autowired
	private ContextDistributeTrendDao contextDistributeTrendDao;
	...
	public Page<CommonFlush> queryByPage(GridServerHandler gridServerHandler,
		...
		page.setTotalCount(contextDistributeTrendDao.getTotalCount(Common
		...
		return contextDistributeTrendDao
	...
	public List<CommonFlush> queryAll(String timeLevel, String businessName,
		...
		List<CommonFlush> list = contextDistributeTrendDao
...
//	}
	...
	private String getTableName(int timeLevel) {
		...
		switch (timeLevel) {
		case 1:
			tableName = "ftbStatHourGprsContent_V2";
			break;
		case 2:
			tableName = "vStatDayGprsContent_V2";
			break;
		case 3:
			tableName = "vStatWeekGprsContent_V2";
			break;
		case 4:
			tableName = "vStatMonthGprsContent_V2";
			break;
		}
		return tableName;
	}
