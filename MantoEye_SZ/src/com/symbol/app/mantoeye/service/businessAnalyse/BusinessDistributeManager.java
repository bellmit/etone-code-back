...
// 默认将类中的所有函数纳入事务管理.
@Transactional
public class BusinessDistributeManager extends
	...
	public List<CommonFlush> queryBussDistribute(int timeLevel, String date,
		...
		return businessDistributeDAO.queryBusinessDistribute(timeLevel, date,
	...
	public Page<CommonFlush> queryBussDistributePage(Page<CommonFlush> page,
			...
			String business) {
		businessDistributeDAO.initMap();
		return businessDistributeDAO.queryBussDistributePage(page, timeLevel,
	...
	public Page<CommonFlush> query(final Page page, int isTD, int areaType,
		...
		return businessDistributeDAO.query(page, isTD, areaType, timeLevel,
				time, business);
	}

	public List<CommonFlush> listData(final Page page, int isTD, int areaType,
			int timeLevel, String time, String business) {
		return businessDistributeDAO.listData(page, isTD, areaType, timeLevel,
				time, business);
	}
	...
	public Map<String, Map<String, String>> queryBussAndBussType() {
		...
		List<BussAndBussType> list = businessDistributeDAO
	...
	public List<TopFlushBean> queryTop10Busi(String startTime, String endTime,
		...
		if ("total".equals(type)) {
			list = businessDistributeDAO.queryTotalFlush(startTime, endTime,
					type);
		} else {
			list = businessDistributeDAO.queryTop10Busi(Common
	...
	public List<TopFlushBean> queryHourDataByName(String date, String edate,
		...
		if ("全网".equals(busiName)) {
			...
			if (null != bean && !"".equals(bean.getName())
					&& null != bean.getName()) {
				list = businessDistributeDAO.queryHourDataByName(sdate, eedate,
						bean.getName());
			} else {
				list = new ArrayList<TopFlushBean>();
			}
		} else {
			list = businessDistributeDAO.queryHourDataByName(date, edate,
					busiName);
		}
	...
	public TopFlushBean getBean(String date, String busiName) {
		TopFlushBean bean = businessDistributeDAO.queryTop10Busi2(Common
	...
	public List<TopFlushBean> querySpaceDataByName(String date,
		...
		if ("全网".equals(busiName)) {
			...
			list = businessDistributeDAO.queryTotalFlush(date, tableName,
					"totalSpace");
		} else {
			list = businessDistributeDAO.querySpaceDataByName(Common
