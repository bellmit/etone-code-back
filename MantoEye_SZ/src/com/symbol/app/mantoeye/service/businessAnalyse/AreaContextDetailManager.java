...
import com.symbol.app.mantoeye.dao.businessAnalyse.AreaContextDetailDAO;
import com.symbol.app.mantoeye.dto.flush.CommonFlush;
import com.symbol.wp.modules.orm.Page;

@Service
@Transactional
public class AreaContextDetailManager {

	@Autowired
	private AreaContextDetailDAO areaContextDetailDAO;
	...
	public Page<CommonFlush> query(final Page page, int isTD, 
		...
		return areaContextDetailDAO.query(page, isTD, areaName,
				timeLevel, time);
	}

	public List<CommonFlush> listData(int isTD, String areaName,
			int timeLevel, String time) {
		return areaContextDetailDAO.listData(isTD, areaName,
				timeLevel, time);
	}
