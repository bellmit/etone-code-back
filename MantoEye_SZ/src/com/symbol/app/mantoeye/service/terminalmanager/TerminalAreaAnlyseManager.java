...
@Service
@Transactional
public class TerminalAreaAnlyseManager {

	@Autowired
	private TerminalAreaAnlyseDAO terminalAreaAnlyseDAO;
	...
	public Page<CommonSport> query(final Page page, int isTD,
		...
		return terminalAreaAnlyseDAO.query(page, isTD, timeLevel, time_search,areaType);
	}

	public List<CommonSport> listData(int isTD,int timeLevel, String time_search,int areaType) {
		return terminalAreaAnlyseDAO.listData(isTD, timeLevel, time_search,areaType);
	}
