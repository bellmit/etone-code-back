 ...
 */
@Entity
@Table(name = "ftbDataOutPutTask", schema = "DBA", catalog = "iqwrite")
/**
 * 数据提取任务表。 【重要约束】对于实时提取任务，正在进行的任务和还为开始的任务，涉及的用户号码累计不能超过20个！
 * 任务未开始可以更改任务策略，其它状态则不行！
 * 
 */
public class FtbDataOutPutTask implements java.io.Serializable {
	...
	/** full constructor */
	public FtbDataOutPutTask(Integer intTaskDelong, String vcTaskName,
	...
	@Id
	@GeneratedValue
	@Column(name = "nmDataOutPutTaskId", unique = true, nullable = false, precision = 10, scale = 0)
