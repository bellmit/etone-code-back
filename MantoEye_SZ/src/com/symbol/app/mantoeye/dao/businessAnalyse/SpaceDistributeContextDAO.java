...
@Repository
public class SpaceDistributeContextDAO extends HibernateQueryDAO {
	...
	public String buildSql(int isTD, int areaType, String areaName,
		...
		case 1:
			...
			if (bussType==1) {
				...
				table = (timeLevel == 1) ? "vStatHourBscContentType_V2"
						: (timeLevel == 2) ? "vStatDayBscContentType_V2"
								: (timeLevel == 3) ? "vStatWeekBscContentType_V2"
										: "vStatMonthBscContentType_V2";
			}else {
				fields = " vcName,DimensName as businessName, ";
				table = (timeLevel == 1) ? "vStatHourBscContentType_V2"
						: (timeLevel == 2) ? "vStatDayBscContent_V2"
								: (timeLevel == 3) ? "vStatWeekBscContent_V2"
										: "vStatMonthBscContent_V2";
			}
		...
		case 2:
			...
			if (bussType==1) {
				fields = " vcName,vcGroupName as businessName, ";
				table = (timeLevel == 1) ? "vStatHourSgsnContentType_V2"
						: (timeLevel == 2) ? "vStatDaySgsnContentType_V2"
								: (timeLevel == 3) ? "vStatWeekSgsnContentType_V2"
										: "vStatMonthSgsnContentType_V2";
			}else {
				fields = " vcName,DimensName as businessName, ";
				table = (timeLevel == 1) ? "vStatHourSgsnContentType_V2"
						: (timeLevel == 2) ? "vStatDaySgsnContent_V2"
								: (timeLevel == 3) ? "vStatWeekSgsnContent_V2"
										: "vStatMonthSgsnContent_V2";
			}
		...
		case 3:
			...
			if(bussType==1){
				fields = " vcName,vcGroupName as businessName, ";
				table = (timeLevel == 1) ? "vStatHourStreetContentType_V2"
						: (timeLevel == 2) ? "vStatDayStreetContentType_V2"
								: (timeLevel == 3) ? "vStatWeekStreetContentType_V2"
										: "vStatMonthStreetContentType_V2";
			}else {
				fields = " vcName,DimensName as businessName, ";
				table = (timeLevel == 1) ? "vStatHourStreetContentType_V2"
						: (timeLevel == 2) ? "vStatDayStreetContent_V2"
								: (timeLevel == 3) ? "vStatWeekStreetContent_V2"
										: "vStatMonthStreetContent_V2";
			}
		...
		case 4:
			...
			if (bussType==1) {
				...
				table = (timeLevel == 1) ? "vStatHourSaleAreaContentType_V2"
						: (timeLevel == 2) ? "vStatDaySaleAreaContentType_V2"
								: (timeLevel == 3) ? "vStatWeekSaleAreaContentType_V2"
										: "vStatMonthSaleAreaContentType_V2";
			}else {
				fields = " vcSaleAreaName,DimensName as businessName, ";
				table = (timeLevel == 1) ? "vStatHourSaleAreaContentType_V2"
						: (timeLevel == 2) ? "vStatDaySaleAreaContent_V2"
								: (timeLevel == 3) ? "vStatWeekSaleAreaContent_V2"
										: "vStatMonthSaleAreaContent_V2";
			}
		...
		case 5:
			...
			if (bussType==1) {
				...
				table = (timeLevel == 1) ? "vStatHourCompanyContentType_V2"
						: (timeLevel == 2) ? "vStatDayCompanyContentType_V2"
								: (timeLevel == 3) ? "vStatWeekCompanyContentType_V2"
										: "vStatMonthCompanyContentType_V2";
			}else {
				fields = " vcBranchName,DimensName as businessName, ";
				table = (timeLevel == 1) ? "vStatHourCompanyContentType_V2"
						: (timeLevel == 2) ? "vStatDayCompanyContent_V2"
								: (timeLevel == 3) ? "vStatWeekCompanyContent_V2"
										: "vStatMonthCompanyContent_V2";
			}
