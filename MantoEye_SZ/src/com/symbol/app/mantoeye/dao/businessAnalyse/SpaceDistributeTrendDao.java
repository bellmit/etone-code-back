...
public class SpaceDistributeTrendDao extends CommonQueryDAO {
	...
	public Page<CommonFlush> queryByPage(Page page, int timeLevel,
			...
			String nameColumnName, String nameColumnValue) {

		String sql = buildSql(timeLevel,  startTime,endTime, tableName,
				nameColumnValue, nameColumnName);
	...
	private String buildSql(int timeLevel,
			String startTime,String endTime, String tableName,
			String nameColumnValue, String nameColumnName) {
		...
		sql.append(" and viewArea.");
		sql.append(nameColumnName);
		sql.append(" = '");
		sql.append(nameColumnValue);
		sql.append("'");
		sql.append(" and viewArea.intRaitype = 2");	//查TD数据	V3
