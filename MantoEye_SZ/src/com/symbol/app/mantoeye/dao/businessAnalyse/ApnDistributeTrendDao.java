...
public class ApnDistributeTrendDao extends CommonQueryDAO {
	...
	public Page<CommonFlush> queryByPage(Page page, int timeLevel,
			String startTime, String endTime, String tableName, String apnDomain,String raitype) {
	...
	public List<CommonFlush> queryAll(int timeLevel, String startTime,
			String endTime, String tableName, String apnDomain,String raitype) {
		String sql = buildSql(timeLevel, startTime, endTime, tableName,
				apnDomain,raitype);
	...
	private String buildSql(int timeLevel, String startTime, String endTime,
			String tableName, String apnDomain,String raitype) {
		...
		sql.append(" and viewArea.vcApnTypeName='");
		sql.append(apnDomain);
		sql.append("'");
		sql.append(" and viewArea.intRaitype = "+raitype);
	...
	public int getTotalCount(int timeLevel, String startTime, String endTime,
		...
		sql += buildSql(timeLevel, startTime, endTime, tableName, apnDomain,raitype);
		sql += " ) as totalCount";
