...
@Repository
public class FlushLevelAnalyseDAO extends HibernateDao {
	...
	public List<CommonSport> buildBeanList(List list,String time_search,int timeLevel_search) {
		...
		if (list != null && !list.isEmpty()) {
			...
			commonSport.setVcTerminalBrand(("null").equals(bean[0]+"")||(bean[0]+"")==null?"未知":bean[0]+"");
	...
	public String buildSql(Long nmStatFlushLayeringId,String time_search,int timeLevel_search,Page page) {
		...
		sql = "select dtbTerminal.vcTerminalBrand,sum(ftbStatTerminalFlushLayering.nmUsers) as nmUsers,sum(ftbStatTerminalFlushLayering.nmFlush) as nmFlush,convert(numeric(20,2),(nmFlush/nmUsers)) as nmAveFlush "
			+" from ftbStatTerminalFlushLayering "
			+" left join dtbTerminal on ftbStatTerminalFlushLayering.nmTerminalId = dtbTerminal.nmTerminalId "
			+" where ftbStatTerminalFlushLayering.intRaitype=1 "
			+" and ftbStatTerminalFlushLayering.intYear="+year
			+" and ftbStatTerminalFlushLayering.intMonth="+month
			+" and ftbStatTerminalFlushLayering.intDay="+day
			+" and ftbStatTerminalFlushLayering.nmStatFlushLayeringId="+nmStatFlushLayeringId
			+" group by dtbTerminal.vcTerminalBrand,ftbStatTerminalFlushLayering.nmStatFlushLayeringId,ftbStatTerminalFlushLayering.intYear,ftbStatTerminalFlushLayering.intMonth,ftbStatTerminalFlushLayering.intDay,ftbStatTerminalFlushLayering.intRaitype";
