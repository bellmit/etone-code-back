...
@Repository
public class TerminalAreaAnlyseDAO extends HibernateQueryDAO {
	public Page<CommonSport> query(final Page page, int isTD,
			int timeLevel, String time,int areaType) {
		logger.info(CommonUtils.getDayInnerWeek(time));
	...
	public String buildSql(int isTD, int areaType, int timeLevel, int year,
		...
		case 1:
			...
			fields = " vcTerminalBrand,f.intBscId,vcName ";
		...
		case 2:
			...
			fields = " vcTerminalBrand,f.intSgsnId,vcName ";
		...
		case 3:
			...
			fields = " vcTerminalBrand,f.intBranchId,vcBranchName ";
		...
		case 4:
			...
			fields = " vcTerminalBrand,f.intSaleAreaId,vcSaleAreaName ";
		...
		case 5:
			...
			fields = " vcTerminalBrand,f.intStreetId,vcName ";
