...
@Repository
public class BlackBerryAreaDistinationDAO extends HibernateQueryDAO {
	...
	public String buildSql(final Page page, int isTD, int areaType,
		...
		case CommonConstants.MANTOEYE_APN_SPACE_LEVEL_BSC:
			...
			table = (timeLevel == CommonConstants.MANTOEYE_TIME_LEVEL_HOUR) ? "vStatHourBscBbFlush"
					: (timeLevel == CommonConstants.MANTOEYE_TIME_LEVEL_DAY) ? "vStatDayBscBbFlush"
							: (timeLevel == CommonConstants.MANTOEYE_TIME_LEVEL_WEEK) ? "vStatWeekBscBbFlush"
									: "vStatMonthBscBbFlush";
			break;
		case CommonConstants.MANTOEYE_APN_SPACE_LEVEL_SGSN:
			fields = " intSgsnId,vcName, ";
			table = (timeLevel == CommonConstants.MANTOEYE_TIME_LEVEL_HOUR) ? "vStatHourSgsnBbFlush"
					: (timeLevel == CommonConstants.MANTOEYE_TIME_LEVEL_DAY) ? "vStatDaySgsnBbFlush"
							: (timeLevel == CommonConstants.MANTOEYE_TIME_LEVEL_WEEK) ? "vStatWeekSgsnBbFlush"
									: "vStatMonthSgsnBbFlush";
			break;
		case CommonConstants.MANTOEYE_APN_SPACE_LEVEL_STREET:
			fields = " intStreetId,vcName, ";
			table = (timeLevel == CommonConstants.MANTOEYE_TIME_LEVEL_HOUR) ? "vStatHourStreetBbFlush"
					: (timeLevel == CommonConstants.MANTOEYE_TIME_LEVEL_DAY) ? "vStatDayStreetBbFlush"
							: (timeLevel == CommonConstants.MANTOEYE_TIME_LEVEL_WEEK) ? "vStatWeekStreetBbFlush"
									: "vStatMonthStreetBbFlush";
			break;
		case CommonConstants.MANTOEYE_APN_SPACE_LEVEL_SALEAREA:
			fields = " intSaleAreaId,vcSaleAreaName, ";
			table = (timeLevel == CommonConstants.MANTOEYE_TIME_LEVEL_HOUR) ? "vStatHourSaleAreaBbFlush"
					: (timeLevel == CommonConstants.MANTOEYE_TIME_LEVEL_DAY) ? "vStatDaySaleAreaBbFlush"
							: (timeLevel == CommonConstants.MANTOEYE_TIME_LEVEL_WEEK) ? "vStatWeekSaleAreaBbFlush"
									: "vStatMonthSaleAreaBbFlush";
			break;
		case CommonConstants.MANTOEYE_APN_SPACE_LEVEL_BRANCH:
			fields = " intBranchId,vcBranchName, ";
			table = (timeLevel == CommonConstants.MANTOEYE_TIME_LEVEL_HOUR) ? "vStatHourBranchBbFlush"
					: (timeLevel == CommonConstants.MANTOEYE_TIME_LEVEL_DAY) ? "vStatDayBranchBbFlush"
							: (timeLevel == CommonConstants.MANTOEYE_TIME_LEVEL_WEEK) ? "vStatWeekBranchBbFlush"
									: "vStatMonthBranchBbFlush";
			break;
		}
		sql = " select " + fields;
