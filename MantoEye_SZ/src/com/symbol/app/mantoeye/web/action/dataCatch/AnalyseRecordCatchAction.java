...
public class AnalyseRecordCatchAction extends BaseDispatchAction {
	public String list() throws Exception {
		HttpServletRequest request = Struts2Utils.getRequest();
		String[] wapArray = { "ANA-1", "李四", "是", "8615913140007",
				"2009-10-20", "2009-10-22", "2009-10-22", "1",
				"http://localhost:7000/admin/VIP-1.txt", "1024" };
		String[] netArray = { "ANA-2", "李四", "是", "8615913143434",
				"2009-10-20", "2009-10-22", "--", "0", "--", "--" };
		String[] companyArray = { "ANA-3", "李四", "是", "8615913146666",
