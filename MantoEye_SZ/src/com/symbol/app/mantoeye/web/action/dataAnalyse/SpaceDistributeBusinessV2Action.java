...
import com.symbol.app.mantoeye.service.businessAnalyse.SpaceDistributeBusinessV2Manager;
...
public class SpaceDistributeBusinessV2Action {

	@Autowired
	private SpaceDistributeBusinessV2Manager spaceDistributeBusinessV2Manager;
	...
	public void query() throws ServletException, IOException {
		...
		page = spaceDistributeBusinessV2Manager.query(page, Integer
				.parseInt(dataType_search), Common
				.StringToInt(spaceLevel_search), businessName, Integer
				.parseInt(timeLevel_search), time_search,bussType);
	...
	public void export() throws ServletException, IOException {
		...
		List<CommonFlush> list = spaceDistributeBusinessV2Manager.listData(Common
	...
	public String packTotalData(String dataType, String spaceLevel,
		...
		newPage = spaceDistributeBusinessV2Manager.query(newPage, Integer
				.parseInt(dataType), Common.StringToInt(spaceLevel), areaName,
				Common.StringToInt(timeLevel), time,bussType);
