...
public class BusinessInBusinessTypeV2Action extends BaseDispatchAction {
	...
	public void export() throws ServletException, IOException {
		...
		List<CommonFlush> list = businessDistributeV2Manager
				.queryBusinessDateByType(dataType, Common
						.StringToInt(timeLevel_search), searchDateStart,
						businessTypeName,nmGroupId);
	...
	public void queryBusinessDataByType() {// 根据业务类型查询具体业务分布
		...
		page = businessDistributeV2Manager.queryBusinessDateByTypePage(this.page,
				dataType, Common.StringToInt(timeLevel_search),
				searchDateStart, businessTypeName,nmGroupId);
