...
import com.symbol.app.mantoeye.service.terminalmanager.TerminalUpgradeFlushManager;
...
public class TerminalUpgradeFlushAction extends BaseDispatchAction {
	...
	@Autowired
	private TerminalUpgradeFlushManager terminalUpgradeFlushManager ;
	@Autowired
	...
	public void query() throws ServletException, IOException {
		...
		page = terminalUpgradeFlushManager.query(page, taskId,dataType);
	...
	private String getSortField(String sort) {
		if (sort.indexOf("nmFlush") != -1) {
			return "nmNewTerminalFlush";
		}
		if (sort.indexOf("nmOFlush") != -1) {
			return "nmOldTerminalFlush";
		}
		return sort;
	}
	...
	public void export() throws ServletException, IOException {
		List<CommonSport> list = null;
		list = terminalUpgradeFlushManager.listData(taskId,dataType);
		GridServerHandler gridServerHandler = new GridServerHandler(
				Struts2Utils.getRequest(), Struts2Utils.getResponse());
		String exportmsg = "终端升级流量统计";
