...
import com.symbol.app.mantoeye.service.terminalmanager.TerminalTypeBusinessManager;
 ...
 * 
 */
public class TerminalTypeBusinessAction extends BaseDispatchAction {
	@Autowired
	private TerminalTypeBusinessManager terminalTypeBusinessManager;
	...
	public void query() throws ServletException, IOException {
		...
		page = terminalTypeBusinessManager.query(page, Integer
	...
	public void export() throws ServletException, IOException {
		...
		List<CommonSport> list = terminalTypeBusinessManager.listData(Integer
				.parseInt(dataType_search), Integer
				.parseInt(timeLevel_search), time_search, areaType,nmAreaId,vcTerminalNetType);
		GridServerHandler gridServerHandler = new GridServerHandler(
				Struts2Utils.getRequest(), Struts2Utils.getResponse());
		String exportmsg = "终端类型业务分析"
