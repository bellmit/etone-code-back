...
public class BusinessInSpaceV2Action extends BaseDispatchAction {
	...
	public void export() throws ServletException, IOException {
		...
		List<CommonFlush> list = businessDistributeV2Manager.listData(page,
	...
	public void queryBusinessDataInSpaceDistribute() {
		...
		this.page.setPageSize(gridServerHandler.getPageSize());
		this.page.setPageNo(gridServerHandler.getPageInfo().getPageNum());
		this.page = this.businessDistributeV2Manager.query(this.page, dataType,
