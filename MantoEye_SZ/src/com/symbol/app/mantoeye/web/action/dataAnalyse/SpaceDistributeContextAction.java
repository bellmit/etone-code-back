...
import com.symbol.app.mantoeye.service.businessAnalyse.SpaceDistributeContextManager;
...
public class SpaceDistributeContextAction {

	@Autowired
	private SpaceDistributeContextManager spaceDistributeContextManager;
	...
	public void query() throws ServletException, IOException {
		...
		page = spaceDistributeContextManager.query(page, Integer
	...
	public void export() throws ServletException, IOException {
		...
		List<CommonFlush> list = spaceDistributeContextManager.listData(Common
	...
	public String packTotalData(String dataType, String spaceLevel,
		...
		newPage = spaceDistributeContextManager.query(newPage, Integer
