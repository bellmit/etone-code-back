...
import com.symbol.app.mantoeye.service.businessAnalyse.AreaContextDetailManager;
...
public class AreaContextDetailAction {

	@Autowired
	private AreaContextDetailManager areaContextDetailManager;
	...
	public void query() throws ServletException, IOException {
		...
		page = areaContextDetailManager.query(page, Integer
	...
	public void export() throws ServletException, IOException {
		...
		List<CommonFlush> list = areaContextDetailManager.listData(Common
	...
	public String packTotalData(String dataType,
		...
		newPage = areaContextDetailManager.query(newPage, Integer
