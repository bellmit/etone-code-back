...
import com.symbol.app.mantoeye.service.businessAnalyse.ContextDistributeTrendManager;
...
public class ContextDistributeTrendAction extends BaseAction {

	private static final long serialVersionUID = 2018544402159733587L;
	@Autowired
	private ContextDistributeTrendManager contextDistributeTrendManager;
	@Resource(name = "commonManagerImpl")
	public ICommonManager commonManagerImpl;

	private String timeLevel = "1";
	private String businessName = "社区论坛";
	...
	public void query() {
		...
		List<CommonFlush> list = contextDistributeTrendManager.queryByPage(
	...
	public void export() throws IOException {
		...
		List<CommonFlush> list = contextDistributeTrendManager.queryAll(
