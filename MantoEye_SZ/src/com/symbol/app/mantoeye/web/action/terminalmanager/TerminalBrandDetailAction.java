...
import com.symbol.app.mantoeye.service.terminalmanager.TerminalBrandDetailManager;
...
public class TerminalBrandDetailAction {

	@Autowired
	private TerminalBrandDetailManager terminalBrandDetailManager;
	...
	public void query() throws ServletException, IOException {
		...
		page = terminalBrandDetailManager.query(page, Integer
	...
	public void export() throws ServletException, IOException {
		...
		List<CommonSport> list = terminalBrandDetailManager.listData(Integer
				.parseInt(dataType_search), Integer
				.parseInt(timeLevel_search), time_search, areaType,nmAreaId,vcTerminalBrand);
		GridServerHandler gridServerHandler = new GridServerHandler(
				Struts2Utils.getRequest(), Struts2Utils.getResponse());

		String exportmsg = "终端品牌明细"
