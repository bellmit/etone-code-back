...
import com.symbol.app.mantoeye.service.terminalmanager.TerminalAreaAnlyseManager;
 ...
 * 
 */
public class TerminalAreaAnlyseAction extends BaseDispatchAction {
	@Autowired
	private TerminalAreaAnlyseManager terminalAreaAnlyseManager;
	...
	public void query() throws ServletException, IOException {
		...
		page = terminalAreaAnlyseManager.query(page, Integer
	...
	List<CommonSport> list = terminalAreaAnlyseManager.listData(Integer
			.parseInt(dataType_search), Integer
			.parseInt(timeLevel_search), time_search,areaType);
		GridServerHandler gridServerHandler = new GridServerHandler(
				Struts2Utils.getRequest(), Struts2Utils.getResponse());
