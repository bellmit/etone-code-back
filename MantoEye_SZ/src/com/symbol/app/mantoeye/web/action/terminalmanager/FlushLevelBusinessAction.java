...
import com.symbol.app.mantoeye.service.terminalmanager.FlushLevelBusinessManager;
...
public class FlushLevelBusinessAction extends BaseDispatchAction {
	@Autowired
	private FlushLevelBusinessManager flushLevelBusinessManager ;
	...
	public void query() throws ServletException, IOException {
		...
		page = flushLevelBusinessManager.query(page, nmStatFlushLayeringId,time_search,timeLevel_search);
	...
	public void export() throws ServletException, IOException {
		List<CommonSport> list = null;
		list = flushLevelBusinessManager.listData(nmStatFlushLayeringId,time_search,timeLevel_search);
		GridServerHandler gridServerHandler = new GridServerHandler(
				Struts2Utils.getRequest(), Struts2Utils.getResponse());
