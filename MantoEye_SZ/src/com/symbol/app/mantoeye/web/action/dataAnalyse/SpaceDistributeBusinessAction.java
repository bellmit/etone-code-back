...
import com.symbol.app.mantoeye.service.businessAnalyse.SpaceDistributeBusinessManager;
...
public class SpaceDistributeBusinessAction {

	@Autowired
	private SpaceDistributeBusinessManager spaceDistributeBusinessManager;
	...
	public void query() throws ServletException, IOException {
		...
		page = spaceDistributeBusinessManager.query(page, Integer
				.parseInt(dataType_search), Common
				.StringToInt(spaceLevel_search), businessName, Integer
	...
	public void getAjaxChartXmlData() throws Exception {
		...
		String totalXml = this.packTotalData(dataType_search,
				spaceLevel_search, businessName, timeLevel_search, time_search,
				pageSize);
	...
	public void export() throws ServletException, IOException {
		...
		List<CommonFlush> list = spaceDistributeBusinessManager.listData(Common
				.StringToInt(dataType_search), Integer
				.parseInt(spaceLevel_search), Common
	 ...
	 * @return
	 */
	public String packTotalData(String dataType, String spaceLevel,
		...
		newPage = spaceDistributeBusinessManager.query(newPage, Integer
				.parseInt(dataType), Common.StringToInt(spaceLevel), areaName,
	 ...
	 * 
	 */
	public String packImsisData(String dataType, String spaceLevel,
			String areaName, String timeLevel, String time, int pageSize) {
		Page<CommonFlush> newPage = new Page<CommonFlush>();
		newPage.setPageNo(1);
		newPage.setPageSize(pageSize);
	 ...
	 * 组装访问次数数据
	 */
	public String packCountData(String dataType, String spaceLevel,
			String areaName, String timeLevel, String time, int pageSize) {
		Page<CommonFlush> newPage = new Page<CommonFlush>();
		newPage.setPageNo(1);
		newPage.setPageSize(pageSize);
	...
	public SpaceDistributeBusinessManager getSpaceDistributeBusinessManager() {
		return spaceDistributeBusinessManager;
	}

	public void setSpaceDistributeBusinessManager(
			SpaceDistributeBusinessManager spaceDistributeBusinessManager) {
		this.spaceDistributeBusinessManager = spaceDistributeBusinessManager;
	}
