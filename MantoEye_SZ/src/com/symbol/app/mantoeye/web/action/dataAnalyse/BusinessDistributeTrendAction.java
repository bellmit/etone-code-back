...
@Controller("businessDistributeTrendAction")
@Scope("prototype")
@SuppressWarnings("unchecked")
public class BusinessDistributeTrendAction extends BaseAction {

	private static final long serialVersionUID = 2018544402159733587L;
	private BusinessDistributeTrendManager businessDistributeTrendManager;
	@Resource(name = "commonManagerImpl")
	public ICommonManager commonManagerImpl;

	public BusinessDistributeTrendManager getBusinessDistributeTrendManager() {
		return businessDistributeTrendManager;
	}

	@Resource
	public void setBusinessDistributeTrendManager(
			BusinessDistributeTrendManager businessDistributeTrendManager) {
		this.businessDistributeTrendManager = businessDistributeTrendManager;
	}

	private String timeLevel = "1";
	private String businessName = "彩信";
	...
	public void query() {
		...
		List<CommonFlush> list = businessDistributeTrendManager.queryByPage(
	...
	public void export() throws IOException {
		...
		List<CommonFlush> list = businessDistributeTrendManager.queryAll(
