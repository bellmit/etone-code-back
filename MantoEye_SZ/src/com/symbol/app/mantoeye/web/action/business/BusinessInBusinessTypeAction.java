...
public class BusinessInBusinessTypeAction extends BaseDispatchAction {
	...
	public void export() throws ServletException, IOException {
		...
		List<CommonFlush> list = businessDistributeManager
	...
	public void queryBusinessDataByType() {// 根据业务类型查询具体业务分布
		...
		page = businessDistributeManager.queryBusinessDateByTypePage(this.page,
