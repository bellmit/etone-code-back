...
public class BusinessInBusinessTypeV3Action extends BaseDispatchAction {
	...
	private int dataType = 1;	//默认查GPRS数据	V3
	...
	public void queryBusinessDataByType() {// 根据业务类型查询具体业务分布
		...
		page = businessDistributeV2Manager.queryBussContextByType(this.page,
