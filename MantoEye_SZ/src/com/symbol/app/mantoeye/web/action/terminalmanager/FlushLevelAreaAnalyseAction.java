...
import com.symbol.app.mantoeye.service.terminalmanager.FlushLevelAreaAnalyseManager;
...
public class FlushLevelAreaAnalyseAction extends BaseDispatchAction {
	...
	@Autowired
	private FlushLevelAreaAnalyseManager flushLevelAreaAnalyseManager;
	@Autowired
	...
	public void query() throws ServletException, IOException {
		...
		page = flushLevelAreaAnalyseManager.query(page, nmStatFlushLayeringId,time_search,timeLevel_search,areaType);
	...
	public void export() throws ServletException, IOException {
		List<CommonSport> list = null;
		list = flushLevelAreaAnalyseManager.listData(nmStatFlushLayeringId,time_search,timeLevel_search,areaType);
		GridServerHandler gridServerHandler = new GridServerHandler(
				Struts2Utils.getRequest(), Struts2Utils.getResponse());
