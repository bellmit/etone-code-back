...
public class ContextInContextTypeAction extends BaseDispatchAction {
	...
	private int dataType = 2;	//默认查TD数据	V3
	...
	public void queryBusinessDataByType() {// 根据业务类型查询具体业务分布
		...
		page = contextDistributeManager.queryBusinessDateByTypePage(this.page,
