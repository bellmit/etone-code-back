...
import com.symbol.app.mantoeye.service.businessAnalyse.AreaBusinessDetailV2Manager;
...
public class AreaBusinessDetailV2Action {

	@Autowired
	private AreaBusinessDetailV2Manager areaBusinessDetailV2Manager;
	...
	public void query() throws ServletException, IOException {
		...
		page = areaBusinessDetailV2Manager.query(page, Integer
	...
	public void export() throws ServletException, IOException {
		...
		List<CommonFlush> list = areaBusinessDetailV2Manager.listData(Common
	...
	public String packTotalData(String dataType,
		...
		newPage = areaBusinessDetailV2Manager.query(newPage, Integer
