...
public class SimpleHibernateDaoOld<T, PK extends Serializable> {
	 ...
	 */
	public SimpleHibernateDaoOld() {
		this.entityClass = ReflectionUtils.getSuperClassGenricType(getClass());
		System.out.println("<------------------connect SimpleHibernateDaoOld() 192.168.1.11------------------------>");
	}
	 ...
	 */
	public SimpleHibernateDaoOld(final SessionFactory sessionFactory,
			final Class<T> entityClass) {
		System.out.println("<------------------connect SimpleHibernateDaoOld(final SessionFactory sessionFactory,final Class<T> entityClass) 192.168.1.11------------------------>");
	...
	public void save(final T entity) {
		...
		try {
			// logger.info(getSession()+"----getSession()"+entity);
	...
	public Criteria createCriteria(final Criterion... criterions) {
		...
		if (aliasMap.size() > 0) {
			Set<Entry<String, String>> km = aliasMap.entrySet();
			Iterator<Entry<String, String>> it = km.iterator();
			while (it.hasNext()) {
				Entry<String, String> et = it.next();
				criteria.createAlias(et.getKey(), et.getValue());
			}
			// logger.info(">>>>>>>>>>>>>>>>"+c);
