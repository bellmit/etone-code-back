...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="overflow-x: hidden">
		<form name="beanView" action="/menu_save.do" id="beanForm"
			method="post">
						...
						<div class="inputmain">
							...
							<table cellpadding="0" cellspacing="1" class="formitem">
								<tr>
									...
									<td>
										<input type="text" name="entity.vcMenuName" id="vcMenuName" style="width:270px"/>
									</td>
								...
								<tr>
									...
									<td>
										<input type="text" id="vcPermSymbol"
											name="entity.vcPermSymbol" style="width:270px" />
								...
								<tr>
									...
									<td>
										<select name="entity.btShow" id="btShow" style="width:276px">
											<option value="1"
												<c:if test="${entity.btShow}">selected</c:if>>
												是
											</option>
											<option value="0"
												<c:if test="${!entity.btShow}">selected</c:if>>
