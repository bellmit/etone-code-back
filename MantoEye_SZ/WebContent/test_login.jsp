...
#leftpic img {
	max-width: 360px;
	width: expression(this .     width >     360 ?     "360px" :     this .    
		width +   
		 "px");
}
				...
				<div id="loigncontent">
					<form id="loginForm" method="post" action="/login_in.do"
						...
						<table width="100%" cellspacing="5px">
							...
							<tr valign="middle">
								<td width="60"></td>
								<td align="left" onclick="document.loginForm.submit();"
									style="display: block;cursor:pointer;background-image: url(skin/Default/images/MantoEye/u22.png); background-repeat: no-repeat; height: 31px;">
									<font style="font-size: 14px; font-weight: bold;">&nbsp;&nbsp;&nbsp;&nbsp;登录 </font>
								</td>
							</tr>
						</table>
					</form>
