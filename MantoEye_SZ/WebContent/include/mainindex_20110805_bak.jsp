						...
						<tr>
							<td id="td1">
								<div id="RightPane1">
									...
									<div id="tabs1">
										<ul>
											<li><a href="#imgareas9">全网业务</a>
											</li>
											<li><a href="#imgareas10">十大业务</a>
											</li>
											<li><a href="#imgareas11">十大WAP网站</a>
											</li>
											<li><a href="#imgareas12">十大移动自有业务</a>
											</li>
										</ul>
										<div id="imgareas9" class="tablt">
											<input type="hidden" value="" id="chartxmldata9" />
											<div id="imgarea9" style="width: 100%; height: 100%"></div>
										</div>
										<div id="imgareas10" class="tablt">
											<input type="hidden" value="" id="chartxmldata10" />
											<div id="imgarea10" style="width: 100%; height: 100%"></div>
										</div>
										<div id="imgareas11" class="tablt">
											<input type="hidden" value="" id="chartxmldata11" />
											<div id="imgarea11" style="width: 100%; height: 100%"></div>
										</div>
										<div id="imgareas12" class="tablt">
											<input type="hidden" value="" id="chartxmldata12" />
						...
						<tr>
							<td>
								<div id="RightPane3">
									...
									<div id="tabs3">
										<ul>
											<li><a href="#imgareas30" id="subFlushTrend">全网业务—＞日走势</a>
											</li>
										</ul>
										<div id="imgareas30" class="tablt">
						...
						<tr>
							<td>
								<div id="RightPane4">
									...
									<div id="tabs4">
										<ul>
											<li><a href="#imgareas40" id="subFlushSpace">全网业务—＞日空间分布</a>
											</li>
										...
										<div id="imgareas40" class="tabmap">
											<input type="hidden" value="" id="spacexml40" /> <input
												type="hidden" value="" id="defaultchartjson" />
											<iframe name="frm40"
...
function exitSystem() {
	if (confirm("是否要退出系统？"))
		window.open('/login_exit.do', '_blank', '');
		parent.window.close();
}
//修改密码
function changePwd() {
