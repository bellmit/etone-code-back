...
<div id="mainarea">
  ...
  <div id="mainDiv"
	style="width: 100%; position: absolute; border: 1px solid #8DB2E3; margin: 3px; padding: 2px;">
    <div
	style="width: 50%; top: 0px; left: 0px; border: 1px solid #8DB2E3; padding: 2px; float: left;">
      <div id="RightPane1" style="width: 98%">
        <!-- Tabs pane -->
        <div id="tabs1">
          <ul>
    ...
    <div
	style="width: 50%; top: 0px; float: left; border: 1px solid #8DB2E3; padding: 2px; margin-left: 1px;">
      <table id="list20">
      </table>
      <div id="plist20"></div>
    </div>
    <div
	style="width: 50%; left: 0px; border: 1px solid #8DB2E3; padding: 2px; float: left; margin-top: 1px;">
      <div id="RightPane3">
        <!-- Tabs pane -->
        <div id="tabs3">
          <ul>
      ...
      <div id="RightPane4">
        ...
        <div id="tabs4">
          <ul>
            ...
            <select id="chdata40" onchange="dataTypeChange();" style="height: 22px">
              <option value="1" selected>流量</option>
              <option value="2">用户数</option>
            </select>
            <select id="space40" onchange="spaceTypeChange();" style="height: 22px">
          ...
          <div id="imgareas40" class="tabmap">
            <input type="hidden" value=""
	id="spacexml40" />
            <input type="hidden" value="" id="defaultchartjson" />
            <iframe name="frm40"
