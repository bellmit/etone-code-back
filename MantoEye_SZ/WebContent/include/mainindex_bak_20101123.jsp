...
<div id="mainarea" style="overflow: hidden;">
  ...
  <table>
    <tr>
      <td id="td11"
			style="width: 50%; height: 278px; border: 1px solid #8DB2E3;"><table style="width: 100%;">
          <tr>
            <td><div id="RightPane1" style="width: 100%;">
                <!-- Tabs pane -->
                <div id="tabs1">
                  <ul>
      ...
      <td id="td12"
		...
		<table id="list20" style="width: 100%;">
        </table>
        <div id="plist20" style="width: 100%;"></div></td>
    </tr>
    <tr>
      <td id="td21"
			style="width: 50%; height: 278px; border: 1px solid #8DB2E3;"><table style="width: 100%;">
          <tr style="width: 100%;">
            <td><div id="RightPane3" style="width: 100%;">
                <!-- Tabs pane -->
                <div id="tabs3">
                  <ul>
      ...
      <td id="td22"
			style="width: 50%; height: 278px; border: 1px solid #8DB2E3"><table style="width: 100%;">
          <tr>
            <td><div id="RightPane4" style="width: 100%;">
                <!-- Tabs pane -->
                <div id="tabs4">
                  <ul>
...
function changewh(){
	...
	if(x=='1280'){
		...
		$('#list20').css('width','680px');
		$('#plist20').css('width','680px');
