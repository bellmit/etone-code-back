...
(function($) {
	...
	$.extend($.validator, {
		...
		methods : {
			...
			//以13或15或18开头的长度为11的数字组合
			mobil : function(value, element) {
				if(value.length==0){
					return true;
				}
				if (value.length > 11) {//验证多个手机号码以“，”或","分隔
					//var reg0 = /^(((13[0-9]{1})|(15[0-9]{1})|(18[0-9]{1}))+\d{8}，)*(((13[0-9]{1})|(15[0-9]{1})|(18[0-9]{1}))+\d{8})$/;
					//var reg1 = /^(((13[0-9]{1})|(15[0-9]{1})|(18[0-9]{1}))+\d{8},)*(((13[0-9]{1})|(15[0-9]{1})|(18[0-9]{1}))+\d{8})$/;
					var reg0 = /^((1[1-9]{1})+\d{9}，)*((1[1-9]{1})+\d{9})$/;
					var reg1 = /^((1[1-9]{1})+\d{9},)*((1[1-9]{1})+\d{9})$/;
					var flag = false;
					if (reg0.test(value)) {
						flag = true;
					}
					...
					return (value.length == 11 && /^((1[1-9]{1})+\d{9})$/
								.test(value));
				}
				/**
				return this.optional(element)
