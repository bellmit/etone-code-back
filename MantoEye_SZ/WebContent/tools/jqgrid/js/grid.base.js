;(function ($) {
/*
 * jqGrid 3.8 Beta - jQuery Grid Copyright (c) 2008, Tony Tomov,
 * tony@trirand.com Dual licensed under the MIT and GPL licenses
 * http://www.opensource.org/licenses/mit-license.php
 * http://www.gnu.org/licenses/gpl-2.0.html Date: 2010-08-01
 */
$.jgrid = $.jgrid || {};
$.extend($.jgrid,{
	...
	from : function(source,initalQuery){
		...
		this._compareValues=function(func,f,v,how,t){
			...
			switch(swst) {
				case 'int':
				case 'integer':
					val = isNaN(Number(val)) ? '0' : val; // To be fixed with
															// more inteligent
															// code
					fld = 'parseInt('+fld+',10)';
					val = 'parseInt('+val+',10)';
