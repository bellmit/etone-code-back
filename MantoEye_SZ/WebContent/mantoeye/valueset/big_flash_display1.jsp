										...
										<td width="100%" class="condition_down">
											<table id="query_condition" cellspacing="0px"
												...
												<td class="condition_name" style='width:100px;'>
													...
													<td class="condition_value" colspan="3">
														<input value="" id="s_msisdn" name="s_msisdn" style='width:360px;'/>
													</td>
													<td class="condition_value" colspan="2" style='width:280px;'>
														&nbsp;<span>(支持模糊查询，多个条件之间用逗号','号分开)</span>
													</td>
...
function openFlushTrend(msisdn){
	/*var obj = new Object();
	obj.name='用户流量走势';
	obj.id='BIG_FLUSH_TREND';
	obj.target = '/mantoeye/valueset/big_flush_trend.jsp';	
	obj.msisdn = msisdn;
	obj.searchDateStart = searchDateStart;
	obj.searchDateEnd = searchDateEnd;
...
var colsConfig = [
		...
		{ id : 'strMissdn'      , header : "号码" ,renderer:rendererTrend  ,  sortable:false},
...
var permflag = '<%=btnperm%>';
  var bflags = initBtnPerm('_ADD_BLACK_2',permflag);
  var addBtn = bflags[0];
