...
function renderCondition(value, record, columnObj, grid, colNo, rowNo) {
	var terminalId = record.nmTerminalId;
	var fullDate = record.fullDate;
	var table= '<table><tr>'
			+ '<td><img style="cursor: hand" src="/skin/Default/images/MantoEye/icon/map.png" alt="区域终端" onclick="showDetail(1,\'' + terminalId + '\',\'' + fullDate + '\');" /></td>'
			 + '<td><img style="cursor: hand" src="/skin/Default/images/MantoEye/icon/business.png" alt="业务终端" onclick="showDetail(2,\'' + terminalId + '\',\'' + fullDate + '\');" /></td>'
			+ '</tr></table>'
	return table
}
var w = "1000px";
...
function showDetail(flag,terminalId,fullDate) { 
	var obj = new Object(); 
	obj.taskId = taskId;
	...
	if(flag==2)
	window.showModalDialog("/mantoeye/terminal/Cameratrack_terminalbis.jsp",obj,"dialogWidth="+w+";dialogHeight="+h+";location=no;resizable=no;status=no;toolbar:no;scroll=yes;center=yes");
}
...
var gridConfig = {
	...
	loadURL : '/cameratrackresult_queryTerminalAnalyse.do?taskId=' + taskId + '&taskStartTime='+taskStartTime + '&intTaskStatus='+intTaskStatus,
	exportURL : '/cameratrackresult_exportTerminalAnalyse.do?taskId=' + taskId + '&taskStartTime='+taskStartTime + '&intTaskStatus='+intTaskStatus,
	dataset : dsConfig,
	columns : colsConfig,
	width : 780,
	height : 400,
