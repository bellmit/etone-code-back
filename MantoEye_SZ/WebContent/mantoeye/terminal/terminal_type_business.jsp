...
var obj = window.dialogArguments ;
	...
	var vcTerminalNetType = obj.vcTerminalNetType;
	var vcName =obj.vcName;
	var nmAreaId =obj.nmAreaId;
	if(nmAreaId==null || nmAreaId==''){
		nmAreaId=0;
	}
$('#distribute_data_div').html( vcName + '(' + vcTerminalNetType + ')'+ '业务分布数据');
$('#distribute_chart_div').html( vcName + '(' +  vcTerminalNetType+ ')'+ '业务分布图形');
...
var colsConfig = [
		...
		{ id : 'vcTerminalNetType'      , header : "终端类型" ,sortable:false     },
		{ id : 'vcBussinessName'      , header : "业务"   ,sortable:false   },
...
var gridConfig={
	id : "datagrid",
	loadURL :'/terminalTypeBusiness_query.do?nmAreaId='+nmAreaId+'&dataType_search='+dataType_search+'&time_search='+time_search+'&timeLevel_search='+timeLevel_search+'&vcTerminalNetType='+vcTerminalNetType+'&areaType='+areaType,
	exportURL :'/terminalTypeBusiness_export.do?1=1' ,
	dataset : dsConfig ,
	columns : colsConfig ,
	width:780,
	height:500,
	...
	if(typeof(datagrid.getRecord(0))!="undefined"){
		for(var i = 0 ; i<totalRecords;i++){	
			...
			if(i<10){//图形只显示前10 的数据
				xlabels[i] = record.vcBussinessName; 	
        ...
        items : [{
          ...
          //alert(areaType+"---"+dataType_search+"---"+timeLevel_search+"---"+time_search+"---"+nmAreaId+"---"+vcTerminalNetType)
			...
			var params={
				...
				nmAreaId:nmAreaId,
				vcTerminalNetType:vcTerminalNetType
			};
			//导出
			var fileObj = new Object();
			fileObj.fileName=vcName+'终端类型业务数据';
