...
$('#distribute_data_div').html("("+flushlevel+')KB的业务分析数据');
$('#headTitle').html("("+flushlevel+')KB的业务分析图形');
var dsConfig= {
	//data : data1 ,
	uniqueField : 'no' ,
	fields :[
...
var colsConfig = [
		...
		{ id : 'vcBussinessName'      , header : "业务" ,sortable:true     },
...
var gridConfig={
	id : "datagrid",
	loadURL :'/flushLevelBusiness_query.do?nmStatFlushLayeringId='+obj.nmStatFlushLayeringId+'&time_search='+time_search+'&timeLevel_search='+timeLevel_search,
	exportURL :'/flushLevelBusiness_export.do?1=1' ,
	dataset : dsConfig ,
	columns : colsConfig ,
	width:780,
	height:500,
...
function buildChartData(totalRecords){
	...
	var title = flushlevel+"KB的业务流量|用户数分析图";
