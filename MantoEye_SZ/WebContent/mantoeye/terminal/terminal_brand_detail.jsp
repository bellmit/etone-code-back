...
var obj = window.dialogArguments ;
	...
	if(nmAreaId==null || nmAreaId==''){//为空不能跳转到action
		nmAreaId=0;
	}
$('#distribute_data_div').html( vcName + '(' + vcTerminalBrand + '品牌)'+ '型号分析数据');
$('#distribute_chart_div').html( vcName + '(' +  vcTerminalBrand+ '品牌)'+ '型号分析图形');
...
function setAreaName(value ,record,columnObj,grid,colNo,rowNo){
	return vcName;
}
var colsConfig = [
		{ id : 'fullDate'      , header : "时间",sortable:false     },
		{ id : 'vcName'      , header : "区域" ,sortable:false ,renderer:setAreaName    },
		{ id : 'vcTerminalBrand'      , header : "终端品牌" ,sortable:false     },
		{ id : 'vcTerminalName'      , header : "终端型号"   ,sortable:false   },
...
var gridConfig={
	id : "datagrid",
	loadURL :'/terminalBrandDetail_query.do?nmAreaId='+nmAreaId+'&dataType_search='+dataType_search+'&time_search='+time_search+'&timeLevel_search='+timeLevel_search+'&vcTerminalBrand='+vcTerminalBrand+'&areaType='+areaType,
	exportURL :'/terminalBrandDetail_export.do?1=1' ,
	dataset : dsConfig ,
	columns : colsConfig ,
	width:780,
	height:500,
...
$(document).ready(function(){
      var toolbar = new Toolbar({
        ...
        items : [{
          ...
          useable : 'T',
          handler : function(){
          //alert(areaType+"---"+dataType_search+"---"+timeLevel_search+"---"+time_search+"---"+nmAreaId+"---"+vcTerminalNetType)
             //参数
			var params={
				areaType:areaType,
			...
			fileObj.fileName=vcName+'终端品牌明细';
