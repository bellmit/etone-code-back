...
$('#distribute_data_div').html( vcName + '(' + vcTerminalBrand + '品牌)'+ '业务分析数据');
$('#distribute_chart_div').html( vcName + '(' +  vcTerminalBrand+ '品牌)'+ '业务分析图形');
...
var gridConfig={
	id : "datagrid",
	loadURL :'/terminalBrandBusiness_query.do?nmAreaId='+nmAreaId+'&dataType_search='+dataType_search+'&time_search='+time_search+'&timeLevel_search='+timeLevel_search+'&vcTerminalBrand='+vcTerminalBrand+'&areaType='+areaType,
	exportURL :'/terminalBrandBusiness_export.do?1=1' ,
	dataset : dsConfig ,
	columns : colsConfig ,
	width:780,
	height:500,
      ...
      var toolbar = new Toolbar({
        ...
        items : [{
          ...
          //alert(areaType+"---"+dataType_search+"---"+timeLevel_search+"---"+time_search+"---"+nmAreaId+"---"+vcTerminalNetType)
			...
			fileObj.fileName=vcName+'终端品牌业务数据';
