...
var gridConfig = {
	...
	loadURL : '/cameratrackresult_queryAreaBis.do?taskId=' + taskId+'&areaType='+areaType+'&areaId='+areaId+'&bussinessId='+bussinessId+'&taskStartTime='+taskStartTime+'&dataType='+dataTypeValue,
	exportURL : '/cameratrackresult_exportAreaBis.do?1=1',
	dataset : dsConfig,
	columns : colsConfig,
	width : 780,
	height : 400,
