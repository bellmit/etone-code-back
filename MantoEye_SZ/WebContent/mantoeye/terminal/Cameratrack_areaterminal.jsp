...
var gridConfig = {
	id : "datagrid",
	loadURL : '/cameratrackresult_queryAreaTerminal.do?taskId=' + taskId+'&areaType='+areaType+'&areaId='+areaId+'&terminalId='+terminalId+'&taskStartTime='+taskStartTime+'&dataType='+dataTypeValue,
	exportURL : '/cameratrackresult_exportAreaTerminal.do?1=1',
	dataset : dsConfig,
	columns : colsConfig,
	width : 780,
	height : 400,
