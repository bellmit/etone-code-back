...
function renderCondition(value, record, columnObj, grid, colNo, rowNo) {
	...
	var table= '<table><tr>'
			+ '<td><img style="cursor: hand" src="/skin/Default/images/MantoEye/icon/business.png" alt="区域业务" onclick="showDetail(1,\'' + businessId + '\',\'' + fullDate + '\');" /></td>'
			 + '<td><img style="cursor: hand" src="/skin/Default/images/MantoEye/icon/map.png" alt="终端业务" onclick="showDetail(2,\'' + businessId + '\',\'' + fullDate + '\');" /></td>'
			+ '</tr></table>'
	return table
}
...
function showDetail(flag,businessId,fullDate) { 
	var obj = new Object(); 
	obj.taskId = taskId;
...
var gridConfig = {
	...
	loadURL : '/cameratrackresult_queryBisAnalyse.do?taskId=' + taskId + '&taskStartTime='+taskStartTime + '&intTaskStatus='+intTaskStatus,
	exportURL : '/cameratrackresult_exportBisAnalyse.do?taskId=' + taskId + '&taskStartTime='+taskStartTime + '&intTaskStatus='+intTaskStatus,
	dataset : dsConfig,
	columns : colsConfig,
	width : 780,
	height : 400,
