...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="overflow-x: hidden">
		<form name="beanForm" action="/cameratrack_upNumberFile.do?1=1"
						...
						<div class="inputmain">
							...
							<table cellpadding="0" cellspacing="1" class="formitem">
								...
								<tr>
									...
									<td >
														...
														<input type="radio" name='radio' id="intMsisdnStatus1"
															style="width: 20px; border: 0px;"
															onclick='showDataType(1)'  />
														完全匹配
														<input type="radio" name='radio' id="intMsisdnStatus2"
															style="width: 20px; border: 0px;"
							...
							<tr>
								...
								<td colspan="2" height="30px">
									<span style="color:#0000FF;">提示:上传文件为txt文件，文件中一行一个号码，模糊用户号码不能超过10个，完全匹配的不能超过1000个，</span>
								</td>
							</tr>		
			</table>
