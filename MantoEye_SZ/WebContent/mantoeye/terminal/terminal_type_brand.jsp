...
$('#distribute_data_div').html( vcName + '(' + vcTerminalNetType + ')'+ '终端品牌数据');
$('#distribute_chart_div').html( vcName + '(' +  vcTerminalNetType+ ')'+ '终端品牌图形');
var dsConfig= {
	//data : data1 ,
	uniqueField : 'no' ,
	fields :[
...
var gridConfig={
	id : "datagrid",
	loadURL :'/terminalTypeBrand_query.do?nmAreaId='+nmAreaId+'&dataType_search='+dataType_search+'&time_search='+time_search+'&timeLevel_search='+timeLevel_search+'&vcTerminalNetType='+vcTerminalNetType+'&areaType='+areaType,
	exportURL :'/terminalTypeBrand_export.do?1=1' ,
	dataset : dsConfig ,
	columns : colsConfig ,
	width:780,
	height:500,
      ...
      var toolbar = new Toolbar({
        ...
        items : [{
          ...
          handler : function(){
			...
			fileObj.fileName=vcName+vcTerminalNetType+'终端品牌明细';
