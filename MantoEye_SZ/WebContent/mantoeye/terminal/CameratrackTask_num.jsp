...
var intTaskStatus=	obj.intTaskStatus;
...
var gridConfig={
	id : "datagrid",
	loadURL :'/cameratrack_queryNmMsisdn.do?taskId='+taskId,
	exportURL :'/cameratrack_exportNmMsisdn.do?taskId='+taskId,
	dataset : dsConfig ,
	columns : colsConfig ,
	width:780,
	height:500,
      ...
      var toolbar = new Toolbar({
        ...
        items : [{
          ...
          handler :  function() {
					...
					obj.taskId = taskId;
					obj.status = status;
					var v = showMMDialog('/mantoeye/terminal/CameratrackTask_num_add.jsp',obj,'600px','380px');
          			reloadData(v);
				},
				error : function() {
					alert('服务器出错,请联系管理员!');
          ...
          handler : function(){
          	...
          	if(count>1){
				...
				obj.id = record.id;
				obj.taskId = taskId;
          		var v = showMMDialog('/mantoeye/terminal/CameratrackTask_num_edit.jsp',obj,'600px','380px');
          		reloadData(v);
          	}
          }
        },'-',{
          ...
          handler :  function() {
					...
					obj.taskId = taskId;
					obj.status = status;
					var mm=showMMDialog('/mantoeye/terminal/CameratrackTask_num_up.jsp',obj,'540px','300px');
...
function deleteNmMsisdn(){
	...
	if(flag){
		$.ajax({
			type : "post",
			url : "cameratrack_deleteNmMsisdn.do",
			data : {
				taskId:taskId,
				nmIds:ids
			},
