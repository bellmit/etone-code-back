											...
											<table id="query_condition" cellspacing="0px"
												...
												<tr valign="middle">
													...
													<td class="condition_value">
														<input type="text" name="vcTitleType" id="vcTitleType" value=""
													...
													<td class="condition_value">
														<input type="text" name="vcTitle" id="vcTitle" value=""
															style="height: 17px; width: 115px" />
													</td>
...
var colsConfig = [
		...
		{ id : 'vcTitleType' , header : "栏目类型" ,exportnumber:true},
		{ id : 'vcTitle' , header : "类别" ,exportnumber:true},
		{ id : 'vcKeyword' , header : "关键字" ,exportnumber:true}
];

var gridConfig={
	id : "datagrid",
	loadURL :'/businessSearch_query.do?1=1',
	exportURL :'/businessSearch_export.do?1=1',
	dataset : dsConfig ,
	columns : colsConfig ,
	width:780,
	height:500,
...
function query() {
	...
	//查询条件
	vcTitleType = $('#vcTitleType').attr("value");
	vcTitle = $('#vcTitle').attr("value");
	//传递给后台参数
	var param={
		vcTitleType:vcTitleType,
		vcTitle:vcTitle
	};
...
$(document).ready(function(){
      var toolbar = new Toolbar({
        ...
        items : [{
          ...
          useable : 'T',
          handler : function(){
          		var mm= showMMDialog('/mantoeye/business_rules/business_search/business_search_add.jsp','业务规则搜索功能对照','680px','500px');
          ...
          useable : 'T',
          handler : function(){
          		var mm= showMMDialog('/mantoeye/business_rules/business_search/business_search_up.jsp','上传业务规则搜索功能对照表','680px','500px');
          		 query();
          }
        },'-',{
          type : 'button',
          ...
          handler : function(){
           //参数
			...
			fileObj.fileName='业务规则搜索功能对照';//文件名称
...
function deleteBusiness(){
	...
	if(flag){
		$.ajax({
			type : "post",
			url : "businessSearch_deleteBusiness.do",
			data : {
				ids:ids
			},
