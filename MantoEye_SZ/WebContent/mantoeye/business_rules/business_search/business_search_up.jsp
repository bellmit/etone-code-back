...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="overflow-x: hidden">
		<form name="beanForm" action="/businessSearch_upFile.do?1=1"
						...
						<div class="inputmain">
							...
							<tr>
								...
								<td colspan="3" height="30px">
									<span style="color:#0000FF;">提示:文件类型应为xls结尾的excel文件。共2列：栏目类型，类别，顺序不能颠倒，第一行为标题栏。</span>
								</td>
							</tr>		
			</table>
