...
#content_table_id  th {
	...
	<body style="overflow-x: hidden">
		<form name="beanView" action="/businessSearch_saveSearchWebSite.do"
						...
						<div>
							...
							<table width="100%" cellpadding="0" cellspacing="1"
								...
								<tr>
									...
									<td>
										<input type="text" name="vcTitleType" id="vcTitleType"
								...
								<tr>
									...
									<td>
										<input type="text" name="vcTitle" id="vcTitle"
											style="height: 16px; width: 349px;"  />
									</td>
								</tr>
