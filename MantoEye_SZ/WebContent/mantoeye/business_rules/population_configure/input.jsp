		...
		$(document).ready(function(){
			...
			$("#beanForm").validate({
				rules: { 
					"intType": { 
        				remote: {
        					url:"populationConfigure_checkUnique.do",
        					type:"post" ,
        					data:{"intType":
        							function (){
        								return $("#intType option:selected").val()
        								}
        					}
...
<style>
	...
	<body style="overflow-x: hidden">
		<form name="beanView" action="/populationConfigure_saveConfigure.do"
