...
var colsConfig = [
		...
		{ id : 'businessName'      , header : "业务名称"   ,width:115 },
		{ id : 'nmUpFlush'      , header : "上行流量(KB)"   ,width:100 ,renderer:renderFormatDataInit2  },
		{ id : 'nmDownFlush'      , header : "下行流量(KB)"   ,width:100  ,renderer:renderFormatDataInit2  },
		{ id : 'nmTotalFlush'      , header : "总流量(KB)"   ,width:100,renderer:renderFormatDataInit2  }
		
];
var gridConfig={
	id : "datagrid",
	/* loadURL 支持函数, 该函数返回值是response对象 */
	loadURL :'/dataGetterBusiness_queryMsisdnBusiFlush.do?taskid='+taskid+'&msisdn='+msisdn,
	exportURL :'/dataGetterBusiness_exportMsisdnBusiFlush.do?taskid='+taskid+'&msisdn='+msisdn ,
	dataset : dsConfig ,
	columns : colsConfig ,
	resizable : false,
	showGridMenu : false,
