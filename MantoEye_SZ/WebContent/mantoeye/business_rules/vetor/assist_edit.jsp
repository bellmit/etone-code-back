...
<base target="_self" />
	...
	<body style="overflow-x: hidden">
		<form name="beanView" action="/businessAssistVetor_update.do" id="beanForm"
			method="post">
						...
						<div class="inputmain">
							...
							<table width="9%" cellpadding="0" cellspacing="1"
								...
								<tr>
									...
									<input id="entity.nmBusinessAssistVetorId" type="hidden" value="${entity.nmBusinessAssistVetorId }" name="entity.nmBusinessAssistVetorId" />
								...
								<tr>
									...
									<td>
										<input type="text" name="entity.vcUrl" id="entity.vcUrl" value="${entity.vcUrl}" onchange="hideMsg()"/>
									</td>
								</tr>
								<tr id="busiTypeNameTr" style="display:none" >
									...
									<td>
										<input type="text" name="entity.vcServerIp" id="entity.vcServerIp" value="${ entity.vcServerIp}" onchange="hideMsg()"/>
									</td>
								</tr>
								<tr>
									<th>
									...
									<td>
										<input type="text" name="entity.intPort" id="entity.intPort" value="${entity.intPort }" onchange="hideMsg()"/>
									</td>
									</td>
								</tr>
								<tr id="companyNameTr" >
									...
									<td>
										<input type="text" name="entity.vcApn" id="entity.vcApn" value="${entity.vcApn }" onchange="hideMsg()"/>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<input type="text" name="entity.vcUserAgent" id="entity.vcUserAgent" value="${entity.vcUserAgent }" onchange="hideMsg()"/>
									</td>
								</tr>
								<tr>
									<th>&nbsp;</th>
								...
								<tr>
									<th><font color="red">注：</font></th>
									<td >
										<div  style="width:62%;"><span><font color="blue">如果此规则是检验规则（将会关联翻译规则）为了防止误判断翻译规则，请尽量将规则信息填写完全。</font>
										</span>
										</div>
									</td>
								</tr>
...
<script>
	...
	function checkAllNull(){
		...
		if(allvalue==''){
			...
			document.getElementById('checkinfo').innerText = "Url/Port/APN/UserAgent必须至少有一个不为空";
		}else{
			checkUniqueByAjax();
		}
	}
...
function checkUniqueByAjax(){
	$.ajax({
		type : "post",
		url : "businessAssistVetor_checkUnique.do",
		data : {
			keyid:document.getElementById('entity.nmBusinessAssistVetorId').value,
