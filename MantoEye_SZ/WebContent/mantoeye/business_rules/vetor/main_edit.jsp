...
<base target="_self" />
	...
	<body style="overflow-x: hidden">
		<form name="beanView" action="/businessMainVetor_update.do" id="beanForm"
			method="post">
						...
						<div class="inputmain">
							...
							<table width="9%" cellpadding="0" cellspacing="1"
								...
								<tr>
									...
									<input id="entity.nmBusinessMainVetorId" type="hidden" value="${entity.nmBusinessMainVetorId }" name="entity.nmBusinessMainVetorId" />
									...
									<%--<a href="#" onclick="showID()"><span>ID测试</span>--%></td>
								</tr>
...
function checkUniqueByAjax(){
	$.ajax({
		...
		data : {
			keyid:document.getElementById('entity.nmBusinessMainVetorId').value,
...
/*
function showID(){
	var bid = document.getElementById("business").value;
	var bids = document.getElementById("").value;
}*/
</script>
