			...
			$("#beanForm").validate( {
				rules : {
					"entity.vcBussinessName" :{ 
        				required: true, 
        				remote: "businessSite_checkUnique.do?vcBussinessName="+encodeURIComponent('${entity.vcBussinessName}')
    				},
					"busiTypeId" :"required",
...
<base target="_self" />
	...
	<body style="overflow-x: hidden">
		<form name="beanView" action="/businessSite_save.do" id="beanForm"
			method="post">
								...
								<tr>
									...
									<td>
										<textarea name="entity.vcBussinessNote"
											id="entity.vcBussinessNote" rows="4" cols="48"></textarea>
									</td>
								</tr>
							</table>
						</div>
