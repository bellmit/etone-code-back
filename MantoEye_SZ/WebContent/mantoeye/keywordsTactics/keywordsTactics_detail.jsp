...
var colsConfig = [
		...
		{ id : 'vcSoName'    , header : "搜索引擎"   ,sortable:true ,exportnumber:true},
		{ id : 'vcKeyValues'     , header : "关键字"    ,sortable:true ,exportnumber:true},
		{ id : 'isExactMark'  , header : "是否精确匹配"  ,sortable:true ,exportnumber:true }
];

var gridConfig={
	id : "datagrid",
	loadURL :'/modules/keywordsTactics/keywords-tactics!queryKey.do?id='+nmId+'&startTime='+startTime+'&endTime='+endTime,
	exportURL :'/modules/keywordsTactics/keywords-tactics!exportKey.do?1=1',
	dataset : dsConfig ,
	columns : colsConfig ,
	width:780,
	height:500,
...
function query() {
	...
	//传递给后台参数
	datagrid.loadURL = '/modules/keywordsTactics/keywords-tactics!queryKey.do?id='+nmId+'&startTime='+startTime+'&endTime='+endTime;
