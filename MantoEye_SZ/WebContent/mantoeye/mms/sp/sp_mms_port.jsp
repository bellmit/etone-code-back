										...
										<td width="100%" class="condition_down">
											<table id="query_condition" cellspacing="0px"
												...
												<tr valign="middle">
													...
													<td class="condition_value">
														<input type="text" name="port" value="" id="port" />
													</td>
													<td class="condition_name">
														公司：
													</td>
...
var colsConfig = [
		...
		{ id : 'company'      , header : "公司"  ,sortable:false   },
...
var gridConfig={
	id : "datagrid",
	loadURL :'/spMmsPort_query.do',
	exportURL :'/spMmsPort_export.do?1=1' ,
	dataset : dsConfig ,
	columns : colsConfig ,
	width:780,
	height:500,
