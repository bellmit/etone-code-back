	...
	<tr valign="top">
		...
		<table cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff"
			...
			<tr valign="top" style="background-color: #D3E0F2;">
				<td>
				<table style="width: 100%; margin: 0px; margin-bottom: 2px;"
					bgcolor="#D3E0F2">
					<tr>
						<td>流量异常的个数小于<input type="text" id="alarmLimitWarm"
							style="width: 120px;" name="alarmLimitWarm" value="${warmBean }"
							onkeyup="clearNoNum(this);" />个</td>
						<td></td>
					</tr>
					<tr>
...
{ 
   ...
   if(obj.value>100 && 'alarmLimitWarm' != obj.id){
   		alert('百分比不允许超过100!');
   		obj.focus();
   		obj.value='';
   		return;
