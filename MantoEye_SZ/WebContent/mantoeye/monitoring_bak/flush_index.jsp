							...
							<tr>
								...
								<table>
									...
									<tr align="center" valign="middle">
										<td colspan="2">
										<div id="mainbtn" style="padding-left: 26px;">
										<ul>
											<li><a href="javascript:showHistoryWarn('BSC');"
												style="width: 90px;" title="查看历史告警"><span>历史告警</span> </a></li>
										</ul>
										</div>
									</tr>
								</table>
...
*/
	...
	function rendDetail2(value ,record,columnObj,grid,colNo,rowNo){
		...
		if(v>10){
			return '<font color="red">'+v+'<img src="/mantoeye/monitoring/img/light.gif" alt="严重超出阀值"/></font>';
		}else{
			return v;
		}
	}
	...
	function rendDetail(value ,record,columnObj,grid,colNo,rowNo){
		...
		return '<div id="mainbtn" style="padding-left: 26px;">'
