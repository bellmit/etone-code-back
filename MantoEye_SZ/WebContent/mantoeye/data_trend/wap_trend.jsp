...
var gridConfig={
	...
	loadURL :'/protocolDistribute_queryTrend.do?1=1',
        ...
        items : [{
          ...
          handler : function(){
           //参数
			...
			fileObj.fileName='应用协议'+tcpName+'时间走势数据';//('+startTime_search+'至'+endTime_search+')';//文件名称
...
function getAllWap(){
	$.ajax({
		type : "post",
		url : "/protocolDistribute_getAllWap.do",
		dataType: 'json',
		success : function(data) {
			...
			for(var i=0;i<jn.length;i++){
				...
				if(jn[i].name.toUpperCase() == 'WAP2.0'){
