...
var gridConfig={
	...
	loadURL :'/contextDistributeTrend_query.do?1=1',
	exportURL :'/contextDistributeTrend_export.do?1=1' ,
	dataset : dsConfig ,
	columns : colsConfig ,
	width:780,
	height:500,
...
charinit = false;
	$.ajax({
		type : "post",
		dataType: 'json',
		url : "contextDistributeTrend_getAjaxChartXmlData.do?1=1",
		data : param,
...
$(document).ready(function(){
 ...
 function exportToXls(){
	...
	fileObj.fileName='内容'+businessName+'时间走势数据';
...
$(document).ready(function(){
	...
	$.ajax({
			type:"post", 
			url:"contextDistribute_initBussnessDialogData.do", 
			dataType:"xml", 
			data:{
