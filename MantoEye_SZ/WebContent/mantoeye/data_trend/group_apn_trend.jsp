...
var gridConfig={
	...
	loadURL :'/blocApnDistribute_queryTrend.do?1=1',
	exportURL :'/blocApnDistribute_exportTrend.do?1=1' ,
	dataset : dsConfig ,
	columns : colsConfig ,
	width:780,
	height:500,
...
function getAjaxChartXmlData(){
	$.ajax({
		type : "post",
		dataType: 'json',
		url : "blocApnDistribute_getAjaxTrendChartData.do?1=1",
		data : {
				dataType_trend:dataType_search,//TD标识
				timeLevel_trend:timeLevel_search,//时间粒度  1:小时 2:天 3:周 4:月
				startTime_trend:startTime_search,//开始时间
        ...
        items : [{
          ...
          handler : function(){
           //参数
			...
			fileObj.fileName='集团APN-'+apnName+'时间走势数据';//('+startTime_search+'至'+endTime_search+')';//文件名称
