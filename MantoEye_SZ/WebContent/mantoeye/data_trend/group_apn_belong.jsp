									...
									<tr valign="top">
										<td width="100%" class="condition_down">
											<table id="query_condition" cellspacing="0px"
												...
												<td height="22px;">
														<select name="belong_search" id="belong_search"
															style="width: 120px; height: 22px; border: 1px solid #FFDDEE; font-size: 11px; color: #163877; display: block;" >
															<option value="1" selected>
																本地
															</option>
															<option value="2" >
...
var gridConfig={
	...
	loadURL :'/groupbusinessuserbelong_queryTrend.do?1=1',
	exportURL :'/groupbusinessuserbelong_exportTrend.do?1=1' ,
	dataset : dsConfig ,
	columns : colsConfig ,
	width:780,
	height:500,
...
function query() {
	...
	belongId = $("#belong_search option:selected").val();
...
function getAjaxChartXmlData(){
	$.ajax({
		type : "post",
		dataType: 'json',
		url : "groupbusinessuserbelong_getAjaxTrendChartData.do?1=1",
		data : {
				dataType_trend:dataType_search,//TD标识
				timeLevel_trend:timeLevel_search,//时间粒度  1:小时 2:天 3:周 4:月
				startTime_trend:startTime_search,//开始时间
        ...
        items : [{
          ...
          handler : function(){
           //参数
			...
			fileObj.fileName='集团APN-'+apnName+'-'+getUserBelong(belongId)+'时间走势数据';//('+startTime_search+'至'+endTime_search+')';//文件名称
