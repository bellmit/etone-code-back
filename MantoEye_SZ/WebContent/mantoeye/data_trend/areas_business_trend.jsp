...
var gridConfig={
	...
	autoLoad:false,
	loadURL :'/areasBusinessTrend_query.do?',
	exportURL :'/areasBusinessTrend_export.do?1=1' ,
	dataset : dsConfig ,
	columns : colsConfig ,
	width:780,
	height:500,
...
function getHeadTitle(){
	//$('#headTitle').html('【'+queryDateStart+'】到【'+queryDateEnd+'】【'+areaValue +'】 区域时间走势图');
}
var charinit = true;
...
charinit = false;
	$.ajax({
		type : "post",
		dataType: 'json',
		url : "areasBusinessTrend_getAjaxChartXmlData.do?1=1",
		data : param,
...
$(document).ready(function(){
	...
	$.ajax({
			type:"post", 
			url:"areasBusinessTrend_initAreaDialogData.do", 
			dataType:"xml", 
			data:{
...
$(document).ready(function(){
 ...
 function exportToXls(){
	...
	fileObj.fileName='区域'+areaValue+'时间走势数据';
