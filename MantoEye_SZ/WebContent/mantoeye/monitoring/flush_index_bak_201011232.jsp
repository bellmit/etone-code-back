	...
	function getEndWdate(){
	 ...
	 $(document).ready(function(){
	  ...
	  function buildChartData(json){
	  	...
	  	tdatas[0] = buildLineChartTip(obj1.datas,xlabels1,lunit);
	  	...
	  	tdatas[1] = buildLineChartTip(obj2.datas,xlabels2,lunit2);
	  	...
	  	tdatas[2] = buildLineChartTip(obj3.datas,xlabels3,lunit3);
	  	...
	  	tdatas[3] = buildLineChartTip(obj4.datas,xlabels4,lunit4);
