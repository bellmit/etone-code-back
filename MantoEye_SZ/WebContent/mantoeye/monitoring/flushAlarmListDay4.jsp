...
<script type="text/javascript">
	...
	var gridConfig={
			id : "datagrid",
			loadURL :'/flushAlarm_queryHistoryDayWarm.do?1=1&startDate='+startDate+'&type='+type,
		 ...
		 if(!initHasData){
			...
			// alert(type);
			 if('TD' == type||'GPRS' == type){
					...
					datagrid.getColumn('fullDate').setWidth(186);
				} 
		judgeData(datagrid);
		//initGridInfo(obj);
	}
	...
	function query(){
		...
		*/
		...
		GT.$grid('datagrid').loadURL='/flushAlarm_queryHistoryDayWarm.do?1=1' ;
