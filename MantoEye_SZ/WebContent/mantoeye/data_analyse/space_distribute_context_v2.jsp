			...
			<tr>
				<td>
					<table cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff"
						style="width: 100%">
						<tr style="height: 25px"><td width="100%" class="condition_down">
...
var bussType=1;
$('#distribute_data_div').html( spaceName + '(' +  businessName+ ')'+ '内容分布数据');
$('#distribute_chart_div').html( spaceName + '(' + businessName + ')'+ '内容分布图形');
...
var colsConfig = [
		...
		{ id : 'businessName'      , header : "内容"   ,sortable:false   },
...
var gridConfig={
	id : "datagrid",
	loadURL :'/spaceDistributeContext_query.do?businessName='+obj.businessName+'&dataType_search='+dataType_search+'&timeLevel_search='+timeLevel_search+'&time_search='+time_search+'&spaceLevel_search='+spaceLevel_search,
	exportURL :'/spaceDistributeContext_export.do?1=1' ,
	dataset : dsConfig ,
	columns : colsConfig ,
	width:780,
	height:500,
        ...
        items : [{
          ...
          handler : function(){
			...
			var params={
				...
				businessName:businessName,//内容
				spaceLevel_search:spaceLevel_search,//表标识
				bussType:bussType
			};
			//导出
			var fileObj = new Object();
			fileObj.fileName=businessName+'内容分布数据';
