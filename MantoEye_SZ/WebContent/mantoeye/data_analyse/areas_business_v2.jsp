										...
										<td width="100%" class="condition_down">
											<table id="query_condition" cellspacing="0px"
												...
												<tr valign="middle">
													...
													<td class="condition_value">
														<div id="mainbtn" style="width:400px">
															<ul>
																<li>
																...
																<li>
																	<a href="javascript:parent.openTab1('/mantoeye/data_analyse/areas_map_cell.jsp?permId=AREAS_MAP_CELL','AREAS_MAP_CELL','自定义小区集');" 
																		style="width:90px;"  title="自定义小区集"><span>定义小区集</span>
																	</a>
																</li>
																<li>
																	<a href="javascript:parent.openTab('/mantoeye/data_analyse/area_population_anlyse.jsp','','常驻人口分析');" 
																		style="width:80px;"  title="常驻人口分析"><span>常驻人口</span>
																	</a>
																</li>
																<li>
																	<a href="javascript:parent.openTab('/mantoeye/data_trend/areas_business_trend.jsp','AREAS_BUSINESS_TREND','小区集时间走势');" 
																		style="width:90px;"  title="时间走势"><span><img onclick="parent.openTab('/mantoeye/data_trend/areas_business_trend.jsp','AREAS_BUSINESS_TREND','小区集时间走势');"
												...
												<td class="condition_name">
													...
													<td >
														<input type="text"  id="areaValue"  value="" style="height: 17px; width: 117px;"/>
													</td>
												</tr>												
											</table>
										</td>
...
function renderInit(value ,record,columnObj,grid,colNo,rowNo){
	...
	return '<table><tr><td><img class="handImg1" style="cursor: hand" src="/skin/Default/images/MantoEye/icon/business.png" alt="查看详细业务" onclick="openDistributeBusiness(1,\''+businessName+'\');" /></td>'
					+'</td><td></div><img class="handImg2" style="cursor: hand" src="/skin/Default/images/MantoEye/icon/business.png" alt="查看详细内容" onclick="openDistributeBusiness(2,\''+businessName+'\');" /></td>'
					+'</tr></table>';
	//return '<img style="cursor: hand" src="/skin/Default/images/MantoEye/icon/business.gif" alt="查看详细业务" onclick="openDistributeBusiness(\''+businessName+'\');" />'
}
var colsConfig = [
		{name : 'business' ,hidden:true       }	,
		{ id : 'fullDate'      , header : "时间" ,sortable:false    },
		{ id : 'businessName'      , header : "小区集名" ,sortable:true   },
...
var gridConfig={
	...
	loadURL :'/areasBusiness_query.do?1=1',
	exportURL :'/areasBusiness_export.do?1=1' ,
	dataset : dsConfig ,
	columns : colsConfig ,	
	width:780,
	height:500,
...
function query() {
	...
	areaValue = $('#areaValue').attr("value");
	if(time_search=='' ){
		alert('请选择时间!');
		return ;
	}
...
function openDistributeBusiness(flag,businessName){
	var obj =new Object();
	...
	obj.spaceName = "";
	if(flag==1){
		window.showModalDialog("/mantoeye/data_analyse/area_business_detail_v2.jsp",obj,"dialogWidth="+w+";dialogHeight="+h+";location=no;resizable=no;status=no;toolbar:no;scroll=yes;center=yes");
	}else{
		window.showModalDialog("/mantoeye/data_analyse/area_context_detail_v2.jsp",obj,"dialogWidth="+w+";dialogHeight="+h+";location=no;resizable=no;status=no;toolbar:no;scroll=yes;center=yes");
	}
