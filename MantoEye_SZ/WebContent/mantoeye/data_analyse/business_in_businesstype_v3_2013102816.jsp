...
var gridConfig={
	id : "datagrid",
	loadURL :'/businessinbusinesstypeV3_queryBusinessDataByType.do?businessTypeName='+obj.businessTypeName+'&dataTypeValue='+obj.dataTypeValue+'&searchDateStart='+searchDateStart+'&timeLevel_search='+obj.timeLevel_search+'&nmGroupId='+obj.nmGroupId,
	exportURL :'/businessinbusinesstypeV3_export.do?1=1' ,
	dataset : dsConfig ,
	columns : colsConfig ,
	width:780,
	height:500,
