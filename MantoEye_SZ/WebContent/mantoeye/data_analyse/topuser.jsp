				...
				<td>
					<table cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff"
						...
						<tr>
							...
							<input type="hidden" id="exportFileName" name = "exportFileName" value="用户数TOP100小区分布数据"/>
								<div class="gt-panel"
...
var gridConfig={
	...
	loadURL :'/topUserDistribute_query.do?1=1',
	exportURL :'/topUserDistribute_export.do?1=1' ,
	dataset : dsConfig ,
	columns : colsConfig ,
	width:780,
	height:500,
...
function loadComplate(){
	...
	var d = $('#d_searchDateStart').attr('value');
	$('#exportFileName').attr('value','['+d+']流量TOP100小区');
}
...
$(document).ready(function(){
 ...
 //参数
	...
	fileObj.fileName='用户数TOP100小区分布数据';//('+startTime_search+'至'+endTime_search+')';//文件名称
