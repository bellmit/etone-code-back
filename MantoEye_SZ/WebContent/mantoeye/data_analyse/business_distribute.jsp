						...
						<table id="query_condition" cellspacing="0px"
							...
							<tr valign="middle">
								...
								<ul>
									...
									<li><a
										href="javascript:parent.openTab('/mantoeye/data_trend/business_distribute_trend.jsp','FLUSH_BUSI_DATE','业务时间走势');"
										style="width: 90px;" title="时间走势"><span><img
										onclick="parent.openTab('/mantoeye/data_trend/business_distribute_trend.jsp','FLUSH_BUSI_DATE','业务时间走势');"
...
var dataTypeValue = 1;//数据类型标识 1GPRS业务
