...
var gridConfig={
	id : "datagrid",
	loadURL :'/businessinbusinesstypeV2_queryBusinessDataByType.do?businessTypeName='+obj.businessTypeName+'&dataType='+dataTypeValue+'&searchDateStart='+searchDateStart+'&timeLevel_search='+obj.timeLevel_search+'&nmGroupId='+obj.nmGroupId,
