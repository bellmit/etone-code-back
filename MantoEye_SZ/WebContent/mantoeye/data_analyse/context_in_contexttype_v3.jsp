...
var colsConfig = [
		...
		{ id : 'business'      , header : "内容明细"     ,sortable:false  },
...
var gridConfig={
	id : "datagrid",
	loadURL :'/contextincontexttypeV3_queryBusinessDataByType.do?businessTypeName='+obj.businessTypeName+'&dataType='+dataTypeValue+'&searchDateStart='+searchDateStart+'&timeLevel_search='+obj.timeLevel_search,
	exportURL :'/contextincontexttypeV3_export.do?1=1' ,
	dataset : dsConfig ,
	columns : colsConfig ,
	width:780,
	height:500,
