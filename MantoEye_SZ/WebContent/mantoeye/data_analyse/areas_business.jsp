...
function openDistributeBusiness(businessName){
	...
	obj.spaceName = "";
	window.showModalDialog("/mantoeye/data_analyse/area_business_detail.jsp",obj,"dialogWidth="+w+";dialogHeight="+h+";location=no;resizable=no;status=no;toolbar:no;scroll=yes;center=yes");
}
/**
脚本不出错
*/
