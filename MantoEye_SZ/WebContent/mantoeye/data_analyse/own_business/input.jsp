		...
		$(document).ready(function(){
			...
			$("#beanForm").validate({
				rules: { 
					"taskName": { 
        				required: true, 
        				remote: "ownBusinessTask_checkUnique.do?oldTaskName="+encodeURIComponent(encodeURIComponent('${taskEntity.taskName}'))
    			},
          		"beginTime": "required",
    			"endTime":"required",
    			"business":"required",
...
#content_table_id  th {
	...
	<body style="overflow-x: hidden">
		<form name="beanView" action="/ownBusinessTask_updateTask.do" id="beanForm"
