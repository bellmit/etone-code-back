...
var bussinessId = obj.bussinessId;
var vcName = obj.vcName;
$('#distribute_data_div').html('竞争对手业务分析数据');
$('#distribute_chart_div').html('竞争对手业务分析图形');
...
var colsConfig = [
		...
		{ id : 'visit'  , header : "访问次数",headAlign:'right' ,align:'right',exportnumber:true,renderer:renderFormatDataInit2 }
		
];

var gridConfig={
	id : "datagrid",
	loadURL :'/competitorBusiness_query.do?bussinessId='+bussinessId+'&businessName='+businessName+'&time_search='+time_search+'&dataType_search='+dataType_search+'&timeLevel_search='+timeLevel_search+'&spaceLevel_search='+spaceLevel_search+'&vcName='+vcName,
	exportURL :'/competitorBusiness_export.do?1=1',
	dataset : dsConfig ,
	columns : colsConfig ,
	width:780,
	height:500,
