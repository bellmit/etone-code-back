...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="overflow-x: hidden">
		<form name="beanForm" action="/topBusiness_readXLSFile.do?intType=2"
					...
					<td width="100%">
						<div class="inputmain">
							...
							<td colspan="2" height="30px">
								<span style="color:#0000FF;">提示:文件类型应为xls结尾的excel文件。共三列：区域名（必填），小区名，CGI（必填），顺序不能颠倒，第一行为标题栏。</span>
							</td></tr>		
			</table>
