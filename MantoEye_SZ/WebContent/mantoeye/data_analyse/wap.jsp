													...
													<td width="300px">
														<div id="mainbtn" style="width:300px">
															<ul>
																...
																<li>
																	<a href="javascript:parent.openTab('/mantoeye/data_trend/wap_trend.jsp','FLUSH_WAP_DATE','应用协议时间走势');" 
																		style="width:90px;"  title="时间走势"><span><img onclick="parent.openTab('/mantoeye/data_trend/wap_trend.jsp','FLUSH_WAP_DATE','应用协议时间走势');" 
...
var colsConfig = [
		...
		{ id : 'businessName'      , header : "应用协议"     ,sortable:false  },
...
var gridConfig={
	id : "datagrid",
	loadURL :'/protocolDistribute_query.do?protocolType=1&total_time_level='+parent.total_obj.total_time_level+'&total_time_search='+parent.total_obj.total_time_search,
...
function query() {
	...
	datagrid.loadURL ='/protocolDistribute_query.do?protocolType=1&total_time_level='+parent.total_obj.total_time_level+'&total_time_search='+parent.total_obj.total_time_search;
	initChartAgain = true;
