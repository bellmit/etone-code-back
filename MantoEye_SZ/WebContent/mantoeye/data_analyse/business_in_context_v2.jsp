...
var gridConfig={
	id : "datagrid",
	loadURL :'/contextinspace_queryBusinessDataInSpaceDistribute.do?businessName='+obj.businessName+'&dataTypeValue='+obj.dataTypeValue+'&searchDateStart='+searchDateStart+'&timeLevel_search='+obj.timeLevel_search+'&date='+date,
	exportURL :'/contextinspaceV2_export.do?1=1' ,
	dataset : dsConfig ,
	columns : colsConfig ,
	width:780,
	height:500,
...
function getAjaxChartXmlDataSpace(){
	$.ajax({
		type : "post",
		url : "contextinspace_getAjaxChartXmlSpaceData.do?1=1",
		data : {
