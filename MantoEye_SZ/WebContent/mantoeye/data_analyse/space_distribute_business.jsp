...
var spaceLevel_search =	obj.spaceLevel_search ;
...
var gridConfig={
	id : "datagrid",
	loadURL :'/spaceDistributeBusiness_query.do?businessName='+obj.businessName+'&dataType_search='+dataType_search+'&timeLevel_search='+timeLevel_search+'&time_search='+time_search+'&spaceLevel_search='+spaceLevel_search,
	exportURL :'/spaceDistributeBusiness_export.do?1=1' ,
	dataset : dsConfig ,
	columns : colsConfig ,
	width:780,
	height:500,
        ...
        items : [{
          ...
          handler : function(){
			...
			var params={
				...
				spaceLevel_search:spaceLevel_search//表标识
			};
			//导出
