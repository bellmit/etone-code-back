...
var gridConfig={
	id : "datagrid",
	loadURL :'/areaContextDetail_query.do?businessName='+obj.businessName+'&dataType_search='+dataType_search+'&timeLevel_search='+timeLevel_search+'&time_search='+time_search+'&spaceLevel_search=1',
	exportURL :'/areaContextDetail_export.do?1=1' ,
	dataset : dsConfig ,
	columns : colsConfig ,
	width:780,
	height:500,
