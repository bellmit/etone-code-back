...
function renderInit(value ,record,columnObj,grid,colNo,rowNo){
		...
		return '<table><tr>'
					+'</td><td></div><img class="handImg2" style="cursor: hand" src="/skin/Default/images/MantoEye/icon/business.png" alt="查看具体内容分布情况" onclick="openSapceDistribute(2,\''+businessOne+'\','+totalImsis+');" /></td>'
					+'</tr></table>';
}
var dsConfig= {
	//data : data1 ,
...
var colsConfig = [
		...
		{ id : 'localtotalFlushMB', header : "本地总流量(MB)",sortable:false , headAlign : 'right', align : 'right', exportnumber : true, renderer : renderFormatDataInit2}, 
		{ id : 'localtotalFlushKB', header : "本地总流量(KB)", sortable:false ,headAlign : 'right', align : 'right', exportnumber : true, renderer : renderFormatDataInit2}, 
		{ id : 'localtotalFlushGB', header : "本地总流量(GB)", sortable:false ,headAlign : 'right', align : 'right', exportnumber : true, renderer : renderFormatDataInit2},
		{ id : 'intImsis' , header : "用户数"  ,sortable:false ,headAlign:'right' ,align:'right'  ,exportnumber:true  },
		{ id : 'localintImsis', header : "本地用户数", sortable:false ,headAlign : 'right', align : 'right', exportnumber : true},
...
var gridConfig={
	id : "datagrid",
	loadURL :'/contextincontexttype_queryBusinessDataByType.do?businessTypeName='+obj.businessTypeName+'&dataType='+dataTypeValue+'&searchDateStart='+searchDateStart+'&timeLevel_search='+obj.timeLevel_search,
	exportURL :'/contextincontexttype_export.do?1=1' ,
	dataset : dsConfig ,
	columns : colsConfig ,
	width:780,
	height:500,
