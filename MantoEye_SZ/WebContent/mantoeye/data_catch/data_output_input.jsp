			...
			$("#beanForm").validate( {
				rules : {
					...
					"entity1.vcFileName": { 
        				required: true, 
        				remote:{
        					url:"dataOutput_checkUnique1.do",
        					type:"post" ,
        					data:{"vcFileName":
        							function (){
        								return $('#vcFileName').attr('value')
        								}
        					}
        					}
    					},
    				"entity1.vcFileServerIp" :{
    					required: true,
    					maxlength:32 
    				},
					"entity1.vcFilePath" :"required",
					"entity1.nmFileSize" :{
						required: true, 
						number:true 
					}*/
...
#content_table_id  th {
	...
	<body style="overflow-x: hidden">
		<form name="beanView" action="/dataOutput_saveDataOutput.do"
