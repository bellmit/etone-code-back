											...
											<table id="query_condition" cellspacing="0px"
												...
												<tr valign="middle">
													...
													<td class="condition_value">
														<input type="text" name="vcImei" id="vcImei" value=""
...
var colsConfig = [
		...
		{ id : 'vcImei' , header : "IMEI" ,exportnumber:true}
		
];

var gridConfig={
	id : "datagrid",
	loadURL :'/dataOutput_queryvcImei.do?taskId='+taskId,
	exportURL :'/dataOutput_vcImeiexport.do?taskId='+taskId,
	dataset : dsConfig ,
	columns : colsConfig ,
	width:780,
	height:500,
      ...
      var toolbar = new Toolbar({
        ...
        items : [{
          ...
          handler : function(){
          		var obj = new Object();
				obj.taskId = taskId;
				var v = showMMDialog('dataOutput_addImei.do?taskId='+taskId,obj,'600px','380px');
				reloadData(v);
          	/*$.ajax({
				type : "post",
				url : 'dataOutput_checkvcImeiStatus.do',
				data : {
					taskId:taskId
				},
				success : function(status) {
					...
					obj.taskId = taskId;
					obj.status = status;
					var v = showMMDialog('dataOutput_addImei.do',obj,'600px','380px');
          			reloadData(v);
				},
				error : function() {
					alert('服务器出错,请联系管理员!');
          ...
          handler : function(){
          	...
          	if(count>1){
          		...
          		obj.vcImei = record.vcImei;
				obj.id = record.id;
				obj.taskId=taskId;
          		var v = showMMDialog('/mantoeye/data_catch/task_imei_edit.jsp',obj,'600px','380px');
          		reloadData(v);
          	}
          }
        },'-',{
          ...
          handler : function(){
          		var obj = new Object();
				obj.taskId = taskId;
				var v = showMMDialog('dataOutput_updateImei.do?taskId='+taskId,obj,'540px','300px');
				...
				success : function(status) {
					...
					obj.taskId = taskId;
					obj.status = status;
				var mm=	showMMDialog('/mantoeye/data_catch/task_imei_up.jsp',obj,'540px','300px');
          ...
          handler : function(){
           //参数
			...
			fileObj.fileName='IMEI';//('+startTime_search+'至'+endTime_search+')';//文件名称
