...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload='<s:if test="page.totalCount==-1">etone.jumpPage(1)</s:if><s:if test="page.totalCount!=-1">load()</s:if>' style="margin-top:-4px;">
		<s:form id="mainForm" name="mainForm" action="dataOutput_queryCgi.do">
								...
								<td width="44%" height="205" align="left" valign="top"
									...
									<select name="unUnion" multiple="multiple" id="unUnion" ondblclick="addDblclick()"
										...
										<s:iterator value="page.result">
											...
											<option value="${vcCgiChName }_${vcCGI }">${vcCgiChName }——${vcCGI}</option>
...
<script type="text/javascript">
	...
	function addDblclick(){
		...
		document.forms[0].action="/dataOutput_addCgi.do?vcCgi="+vcCgi;
	...
	function remove() {
		...
		document.forms[0].action="/dataOutput_removeCgi.do?vcCgi="+vcCgi;
		return true;
	}
	...
	function removeDblclick() {
		...
		document.forms[0].submit();
			...
			function addall(){
		     ...
		     function removeall(){
		   		document.forms[0].action="/dataOutput_removeAllCgi.do";
				return true;
		   }
