...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="overflow-x: hidden">
		<form name="beanView" action="/dataCatch_saveTask.do?edit=true"
								...
								<tr>
									...
									<td>
										<textarea name="vcMsisdns" id="vcMsisdns" rows="6"
											...
											style="overflow-y: auto; width: 290px;">${vcMsisdns}</textarea>
									</td>
								</tr>
								<tr>
									<th></th>
...
$(document).ready(function(){
	...
	if(taskType==3){//如果获取的是历史解析数据
		$('#beanForm').attr('action','/dataCatch_saveHistoryParseTask.do');
	}
});
