...
function renderManager(value ,record,columnObj,grid,colNo,rowNo){
	...
	var isDec= record.isDec;
	return '<img style="cursor: hand;border:0" onclick="downloadFile(\''+fileid+'\',\''+isDec+'\');" src="/skin/Default/images/MantoEye/icon/download.gif" alt="下载文件" />';
//	return '<a href="fileInfo_download.do?fileid='+fileid+'&isDec='+isDec+'"><img style="cursor: hand;border:0" src="/skin/Default/images/MantoEye/icon/download.gif" alt="下载文件" /></a>';
}
function downloadFile(fileid,isDec){	
	var tn = encodeURIComponent(taskName);
 	openUrl("/fileInfo_downloadForRomote.do?fileid="+fileid+"&isDec="+isDec+"&taskType="+taskType+"&taskName="+tn);
}
var colsConfig = [
...
var gridConfig={
	id : "datagrid",
	loadURL :'/fileInfo_query.do?taskid='+taskId+'&tasktype='+taskType,
	dataset : dsConfig ,
	columns : colsConfig ,
	width:520,
	height:360,
