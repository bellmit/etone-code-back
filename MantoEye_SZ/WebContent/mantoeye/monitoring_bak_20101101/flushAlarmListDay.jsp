...
<script type="text/javascript">
	...
	var colsConfig = [
		  				...
		  				//{ id : 'changeFlush',header : "流量" ,headAlign:'right' ,align:'right',width:120 },	
	...
	function renderFormatAlarm(value ,record,columnObj,grid,colNo,rowNo){
		...
		+'<ul><li><a href="#" onclick="javascript:doCancelWarn(\''+typeName+'\');"' 
	...
	var gridConfig={
			id : "datagrid",
			loadURL :'/flushAlarm_queryHistoryDay.do?1=1&startDate='+startDate+'&type='+type,
	...
	function query(){
		...
		GT.$grid('datagrid').loadURL='/flushAlarm_queryHistoryDay.do?1=1' ;
	...
	function cancelWarn(){
		...
		doCancelWarn(typeNames);
	}

	function doCancelWarn(typeName){
		var obj = new Object();
