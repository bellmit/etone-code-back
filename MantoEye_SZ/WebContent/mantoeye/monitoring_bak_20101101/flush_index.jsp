						...
						<table class="ImgTable">
							...
							<tr style="height: 260px; text-align: center;" align="center"
								...
								<td align="center" valign="middle" id="bscImg"
									...
									id='bscImgArea' />
								<div id="bscImgContent"><img id="bscImgContentSrc"
									src="distinguishRatioAlarm_dial.do?rangeOne=0~1&rangeTwo=1~10&areaFlag=${bscBean.reAlarmRatio}"
									alt="BSC识别率告警示意图" /></div>
								</td>
							</tr>
							<tr>
								...
								<table>
									...
									<tr align="center" valign="middle">
										<td colspan="2">
										<div id="mainbtn"
											style="padding-left: 50px; letter-spacing: 1pt;">
										<ul>
											<li><a href="javascript:showHistoryWarn('BSC');"
												style="width: 96px;" title="查看历史识别率"><span>历史识别率</span>
											</a></li>
										</ul>
										</div>
									</tr>
						...
						<table class="ImgTable">
							...
							<tr style="height: 260px; text-align: center;" align="center"
								...
								<td align="center" valign="middle" id="bscImg"
									style="width: 100%; height: 250px;"><input type='hidden'
									id='cgiImgArea' />
								<div id="cgiImgContent"><img id="cgiImgContentSrc"
									src="distinguishRatioAlarm_dial.do?rangeOne=0~1&rangeTwo=1~10&areaFlag=${cgiBean.reAlarmRatio}"
									alt="CGI识别率告警示意图" /></div>
								</td>
							</tr>
							<tr>
								...
								<table>
									...
									<tr align="center" valign="middle">
										<td colspan="2">
										<div id="mainbtn"
											style="padding-left: 56px; letter-spacing: 1pt;">
										<ul>
						...
						<table class="ImgTable">
							...
							<tr style="height: 260px; text-align: center;" align="center"
								...
								<td align="center" valign="middle" id="bscImg"
									style="width: 100%; height: 250px;"><input type='hidden'
									id='sgsnImgArea' />
								<div id="sgsnImgContent"><img id="sgsnImgContentSrc"
									src="distinguishRatioAlarm_dial.do?rangeOne=0~1&rangeTwo=1~10&areaFlag=${sgsnBean.reAlarmRatio}"
									alt="SGSN识别率告警示意图" /></div>
								</td>
							</tr>
							<tr>
								<td>
						...
						<table class="ImgTable">
							...
							<tr style="height: 260px; text-align: center;" align="center"
								...
								<td align="center" valign="middle" id="bscImg"
									style="width: 100%; height: 250px;"><input type='hidden'
									id='busImgArea' />
								<div id="busImgContent"><img id="busImgContentSrc"
									src="distinguishRatioAlarm_dial.do?rangeOne=0~30&rangeTwo=30~40&areaFlag=${busiBean.reAlarmRatio}"
									alt="业务识别率告警示意图" /></div>
								</td>
							</tr>
							<tr>
