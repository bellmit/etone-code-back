...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="overflow-x: hidden">
		<form name="beanForm" action="/terminalConfigure_upFile.do"
					...
					<td width="100%">
						<div class="inputmain">
							...
							<td colspan="2" height="30px">
								<span style="color:#0000FF;">提示:终端文件的第一行必须为标题，即终端的格式【终端识别前缀|品牌|型号】，中间以“|”分隔，不同记录以换行分隔，文件类型应为dat结尾的txt类型的文件。</span>
							</td></tr>
								<tr>
									<th>
										终端文件：
