						...
						<div>
							...
							<table width="100%" cellpadding="0" cellspacing="1"
								...
								<tr>
									...
									<td>
										<input type="text" value="${taskEntity.terminalNames}" name="terminal" id="terminal"
											readonly onclick="showDialog2()"
											style="width: 350px; height: 16px;"  />
										<div style="height: 0px; border: 0px; overflow: hidden"
											id="terminal_dialog_hidden_id"></div>
										<input id="terminalIds" type="hidden" value="${taskEntity.brandAndType }"
											name="terminalIds"  />
									</td>
