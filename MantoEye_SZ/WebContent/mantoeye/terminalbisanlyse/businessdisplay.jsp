...
*/
var colsConfig=[];
var record={ id : 'terminalName'      , header : "业务名称" , width:80   };
...
var gridConfig={
	...
	loadURL :'/terminalbisanlyse_queryBusinessTerminal.do?1=1&taskId='+taskId2+'&business='+business,
	exportURL :'/terminalbisanlyse_export2.do?1=1' ,
...
//	var ssss = datagrid.getOtherDataInfo();
//	alert(ssss);
        ...
        items : [{
          ...
          handler : function(){
           ...
           //参数
			...
			fileObj.fileName='业务终端分析数据';//('+startTime_search+'至'+endTime_search+')';//文件名称
