		...
		$("#beanForm").validate(
				{
					rules : {
						"entity.vcTaskName" : {
							required : true,
							remote : {
								url : "bishealth_checkUnique.do?oldTaskName="
						...
						<div>
							...
							<table width="100%" cellpadding="0" cellspacing="1"
								...
								<tr>
									...
									<td>
										<input type="hidden" name="entity.nmNetworkTaskId"
											id="nmNetworkTaskId" value="${entity.nmNetworkTaskId}" />
										<input type="text" name="entity.vcTaskName"
											value="${entity.vcTaskName}" style="width: 350px;"
											id="vcTaskName" />
								...
								<tr>
									...
									<td>
										<select name="entity.intTaskType" id="intTaskType"
											style="width: 356px;">
											<option value="1"
												<c:if test="${entity.intTaskType==1}">selected</c:if>>
												GSM健康度
											</option>
											<option value="2"
												<c:if test="${entity.intTaskType==2}">selected</c:if>>
												TD健康度
											</option>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<input type="text" name="entity.dtStartTime"
											...
											onclick="showStartForm()" value="${entity.dtStartTime}" />
									</td>
								</tr>
								<tr>
									<th>
									...
									<td>
										<input type="text" name="entity.dtEndTime"
											...
											onclick="showEndForm()" value="${entity.dtEndTime}" />
									</td>
								</tr>
							<!-- 	<tr>
									<th>
									...
									<td>
										<input type="text" name="entity.intActiveDay"
											value="${entity.intActiveDay}" style="width: 350px;"
											id="intActiveDay" />
								...
								<tr>
									...
									<input type="hidden" id="oldbusiness" name="oldbusiness"
										value="${businessIds}" />
								</tr>
							</table>
						</div>
