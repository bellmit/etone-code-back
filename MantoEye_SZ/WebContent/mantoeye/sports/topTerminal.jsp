...
var colsConfig = [
		...
		{ id : 'context2'    , header : "终端排名前10名" ,exportnumber:false,sortable: false}
];

var gridConfig={
	id : "datagrid",
	loadURL :'/topBusiness_queryTerminal.do?intType=14',
	exportURL :'/topBusiness_exportTerminal.do?intType=14' ,
	dataset : dsConfig ,
	columns : colsConfig ,
	width:780,
	height:500,
        ...
        items : [{
          ...
          handler : function(){
           //参数
			...
			fileObj.fileName='终端排名';//('+startTime_search+'至'+endTime_search+')';//文件名称
