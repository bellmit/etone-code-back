...
var gridConfig={
	id : "datagrid",
	loadURL :'/areaMapCell_query.do?intType=1',
...
$(document).ready(function(){
      ...
      var toolbar = new Toolbar({
        ...
        items : [{
          ...
          useable : bflags[0],
          handler : function(){
          			var mm= showMMDialog('/mantoeye/sports/area_up.jsp','更新保障区域','540px','300px');
						if (typeof (mm) != "undefined") {
									//alert("正在更新保障区域，请稍等一段时间再查看数据！");
									reloadData();
						}else{
								reloadData();
						}
...
function deleteAreaMapCell(){
	...
	function downloadTemplate() {
		...
		obj.contentWindow.location.href = '/topBusiness_downloadTemplate.do?intType=1';
	}
	/**
	 脚本不出错
	 */
