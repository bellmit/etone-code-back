/**
 * z.z.w.othertest.RSA_Encrypt.java
 */
...
public class RSA_Encrypt {
	...
	/** 指定公钥存放文件 */
	private static String PUBLIC_KEY_FILE = "etc/coder/PublicKey";
	/** 指定私钥存放文件 */
	private static String PRIVATE_KEY_FILE = "etc/coder/PrivateKey";
