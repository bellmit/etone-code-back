...
public class TbDielectric implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (intDielectricId != other.intDielectricId)
			return false;
		if (Float.floatToIntBits(nmBalances) != Float
				.floatToIntBits(other.nmBalances))
			return false;
		if (vcNote == null) {
	...
	public String toString() {
		return "TbDielectric [intDielectricId=" + intDielectricId + ", vcNote="
				+ vcNote + ", nmBalances=" + nmBalances + "]";
	}
