 ...
 */
public class FSMysqlOpertor extends CacheDBFactory implements Runnable {
	...
	protected boolean initPreparedStatement() {
		try {
			String sql = " select vcIp,vcUrl,vcsIp,vcsUrl from epmp_tbservicerule_bak ";
