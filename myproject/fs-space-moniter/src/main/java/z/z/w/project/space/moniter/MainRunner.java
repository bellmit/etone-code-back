...
public class MainRunner {
	...
	private static int minSpaceSize = 20;
	...
	private void sortFiles(List<File> list) {
		Collections.sort(list, new Comparator<File>() {
			public int compare(File o1, File o2) {
				// 2G20130718180000.csv
				String o1n = o1.getName();
				// 3G20130718180000.csv
				String o2n = o2.getName();

				// 20130718180000
				String o1nn = o1n.substring(2, o1n.length());
				String o2nn = o2n.substring(2, o2n.length());
				// String o1nn = o1n;
				// String o2nn = o2n;

				return o1nn.compareTo(o2nn);
			}
