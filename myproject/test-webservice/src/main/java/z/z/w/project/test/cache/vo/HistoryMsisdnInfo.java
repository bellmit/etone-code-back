/**************************************************************************
 * <pre>
 *     FileName: z.z.w.project.test.cache.vo.HistoryMsisdnInfo.java
 *         Desc: 
 *      @author: Wu Zhenzhen - myhongkongzhen@gmail.com
 *     @version: 2013-10-4 下午03:10:17 
 *   LastChange: 2013-10-4 下午03:10:17 
 *      History:
 * </pre>
 **************************************************************************/
...
/**
 * z.z.w.project.test.cache.vo.HistoryMsisdnInfo.java
 */
public class HistoryMsisdnInfo {
	...
	/**
	 * <br>
	 * Created on: 2013-10-4 下午03:10:31
	 */
	public HistoryMsisdnInfo() {
		super();
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		HistoryMsisdnInfo other = (HistoryMsisdnInfo) obj;
	...
	/**
	 * <br>
	 * Created on: 2013-10-4 下午03:10:39
	 * 
	 * @return the mONTH_CD
	 */
	...
	public String toString() {
		return "HistoryMsisdnInfo [MONTH_CD=" + MONTH_CD + ", GPRS_FLUX="
				+ GPRS_FLUX + ", ACT_CALL=" + ACT_CALL + ", FLUX_FEE="
				+ FLUX_FEE + ", CALL_FEE=" + CALL_FEE + "]";
	}
